    ...
    def render(context)
      ...
      <<~MARKUP
        <div class="config-vars">
          ...
          <p class="configuration-link" title="Click here to find your configuration file"><a href="/docs/configuration/" target="_blank"><i class="icon-question" />Find your configuration</a>
        </div>
      MARKUP
    end
  end
