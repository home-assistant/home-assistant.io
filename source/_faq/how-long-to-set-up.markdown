---
title: "How long does it take to set up Home Assistant?"
description: "With Home Assistant Green, the basic setup takes about 15 minutes from unboxing to first device. Adding a few more devices and a dashboard takes another 30 to 60 minutes."
ha_category: About Home Assistant
---

The fastest way to get started is with [Home Assistant Green](/green/), the official plug-and-play smart home hub. Basic setup takes about 15 minutes: plug it in, connect it to your network, and walk through the onboarding wizard in your browser.
