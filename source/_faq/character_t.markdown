...
You only need to think about this if you edit YAML by hand. Most users never do, since {% term integrations %}, {% term dashboards %}, and {% term automations %} are all configured through the user interface. If you have not opened a YAML file yourself, this error is most likely coming from a custom integration or a snippet you copied in from somewhere else.
