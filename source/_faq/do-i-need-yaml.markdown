...
Adding {% term integrations %}, building {% term dashboards %}, and creating {% term automations %} are all done from the user interface. The visual automation editor handles the vast majority of automations, and most integrations are set up through a guided dialog with menus and forms.
