...
Iterate over all areas using [`areas`](/template-functions/areas/), filter out areas without a temperature sensor, and then get an area's name using [`area_name`](/template-functions/area_name/).
