---
title: "Arc cosine (inverse cosine): acos"
function_name: "acos"
description: "Returns the arc cosine (inverse cosine) of a value, in radians."
available_as:
  - function
  - filter
category: math
...
This is useful when you need to convert a ratio back into an angle. For example, you could determine the angle between two direction vectors derived from {% term sensor %} data.
...
value:
  description: >
    The value to calculate the arc cosine of. Must be numeric and between -1 and 1.
  required: true
  type: float
default:
  description: >
