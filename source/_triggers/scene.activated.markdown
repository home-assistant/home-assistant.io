...
- This trigger fires whenever the scene is activated, regardless of how. That includes the **Activate scene** action, a tap from the UI or a dashboard, a voice command, or another automation.
