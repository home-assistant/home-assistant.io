...
- To react to the moment blue hour starts, use [Blue hour started](/triggers/sun.blue_hour_started/). To react to full darkness after evening blue hour, use [It is night](/conditions/sun.is_night/) as a condition.
