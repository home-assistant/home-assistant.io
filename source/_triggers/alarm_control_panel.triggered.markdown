...
- To react when the alarm is disarmed after a triggered event, use [Alarm disarmed](/triggers/alarm_control_panel.disarmed/).
...
{% details "YAML example for siren and camera recording" %}
