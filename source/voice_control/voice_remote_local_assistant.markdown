...
2. Setup your assistant.
   ...
   - Optional: Set **Command timeout** between 5 seconds and 5 minutes. This is how long Assist waits for the spoken command to finish before timing out. The default is 15 seconds.
