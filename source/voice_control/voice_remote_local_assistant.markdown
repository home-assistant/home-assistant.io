...
1. Install the add-ons to convert text into speech and vice versa.
   - Install the speech-to-text add-on of your choice, either {% my supervisor_app app="core_speech-to-phrase" title="**Speech-to-Phrase**" %} or {% my supervisor_app app="core_whisper" title="**Whisper**" %}.
   - Install {% my supervisor_app app="core_piper" title="**Piper**" %} for text-to-speech.
   - Start the add-ons.
   ...
   - You now have integrated a local speech-to-text engine of your choice (either {% my supervisor_app app="core_speech-to-phrase" title="**Speech-to-Phrase**" %} or {% my supervisor_app app="core_whisper" title="**Whisper**" %}) and a text-to-speech engine ({% my supervisor_app app="core_piper" title="**Piper**" %}).
...
The options are also documented in the add-on itself. Go to the {% my supervisor_app app="core_whisper" title="**Whisper**" %} or the {% my supervisor_app app="core_piper" title="**Piper**" %} add-on and open the **Documentation** page.
