...
There is no configuration required for editing files within your `/homeassistant` directory. In order to enable access to other directories, it is necessary to edit the add-on's configuration from its configuration tab. See the add-on documentation for details.
...
There is no configuration required for editing files within your `/homeassistant` directory. In order to enable access to further directories, editing the add-on configuration is required. See the add-on documentation for details.
