...
To upgrade to a specific version, you can use the command line (CLI). The example below shows how to upgrade to `{{current_version}}`. To learn how to get started with the command line in Home Assistant, refer to the [SSH app setup instructions](/common-tasks/os/#installing-and-using-the-ssh-app).
