...
Use `ha help` to get more information about the command line usage or refer to the documentation on the [Home Assistant Command Line](/common-tasks/os/#home-assistant-via-the-command-line).
