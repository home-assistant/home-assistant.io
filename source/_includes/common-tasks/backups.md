...
2. Under **Locations**, use the toggle to enable all the backup locations you want to use.
   ...
   - If you want to back up to your NAS (such as [Synology](/integrations/synology_dsm)) or a cloud provider (such as [GoogleDrive](/integrations/google_drive/) or [Microsoft OneDrive](/integrations/onedrive/)), check their integration documentation for specific instructions on setting up a Home Assistant backup.
