...
2. Under **Locations**, use the toggle to enable all the backup locations you want to use.
   - When you choose "This system", if you decide to store your backup locally, besides the download option on the UI under "My Backups", you may also find the resulting backup file under the "/backup" folder in the root filesystem.
