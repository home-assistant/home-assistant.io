...
To add the **{{ name }}** {% unless page.integration_type == "hardware" or page.integration_type == "{{ page.ha_integration_type | default: "integration" }}{% endunless %} to your Home Assistant instance, use this My button:
