...
7. In the applications, search and open **Disks** and start restoring the HAOS image:
   ...
   5. Confirm by selecting **Restore**.
      ...
      - Another issue may be that live Ubuntu are using Swap partition from existing Linux install.
        If you see "Swap" listed as a partition on the drive you're going to wipe, just select it, then press the stop button to unmount it and try again.
