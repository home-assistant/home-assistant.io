...
5. Select what you want to control. Under **By target** (see [Targets](#targets)), select the Sonos speakers you want to snapshot. You can also select an area, a device, or a label.
