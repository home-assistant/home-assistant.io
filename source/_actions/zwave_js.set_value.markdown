...
Use this action to change any value that Z-Wave recognizes on a device. It is for use cases where you need to change the state of a node and can't do it through a regular Home Assistant entity.
