---
title: "Shuffle"
action: collection_image.shuffle
...
6. From the actions shown for that target, select **Shuffle**.
7. Select **Save**.
...
In YAML, refer to this action as `collection_image.shuffle`. A basic example looks like this:
