...
domain: vivotek
description: "Disables motion detection for a VIVOTEK camera."
related_actions:
  - camera.disable_motion_detection
---

Use this action to disable motion detection on a VIVOTEK camera.
...
6. From the actions shown for that target, select **Disable motion detection**.
7. Select **Save**.
...
- This disables the first event configured on the camera.
