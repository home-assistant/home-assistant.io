---
title: Enable motion recording
action: amcrest.enable_motion_recording
domain: amcrest
description: "Lets the camera record a clip when motion is detected."
related_actions:
...
6. From the actions shown for that target, select **Amcrest: Enable motion recording**.
7. Select **Save**.
