...
domain: telegram_bot
description: "Sends a video through a Telegram bot to one or more chats."
---
...
5. From the search box, search for and select **Telegram bot: Send video**.
6. Enter the **URL** or **File** of the video and, optionally, a **Caption** and other options.
7. Choose where to send it.
8. In the **Response variable** field, enter a name to store the data in, such as `video_message`.
9. Select **Save**.
...
{% options_ui %}
Notify target:
  description: "One or more Telegram notify entities to send the video to. Each entity points at a specific bot and chat."
URL:
  description: "Remote path to a video."
File:
  description: "Local path to a video."
Caption:
  description: "The caption shown with the video."
Verify SSL:
