...
5. Select what you want to control. Under **By target** (see [Targets](#targets)), select the Sonos speaker you want to remove an item from. You can also select an area, a device, or a label.
