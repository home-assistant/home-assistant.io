...
Since you've not updated your system a while, we recommend to [create a backup](/common-tasks/general/#backups)
...
menu and select **Show skipped updates**. If this error persists but even after
enabling skipped updates no new OS update appear, you may need to use [the CLI to update to the latest OS version {{site.data.version_data.hassos['ova']}}](/common-tasks/os/#to-update-the-home-assistant-operating-system).
