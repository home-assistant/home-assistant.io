...
System Health integration data can be viewed at {% my repairs title="**Settings** > **System** > **Repairs**" %} > **System Information** in the overflow menu (top right). Or by using the My link below:
