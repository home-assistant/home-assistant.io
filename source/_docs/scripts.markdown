...
The variables action allows you to set/override variables that will be accessible by templates in actions after it (see also [script variables] for how to define locally available variables).
