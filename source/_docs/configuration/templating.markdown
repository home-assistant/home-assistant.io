...
- `is_state('device_tracker.paulus', 'home')` will test if the given entity is the specified state. Or if the state is a list of states, test if the given entity is any of the states in the list, for example: `is_state('device_tracker.paulus', ['home', 'work'])`.
