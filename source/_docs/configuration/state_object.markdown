...
| `state.last_updated` | Time the state or state attributes changed in the state machine in UTC time. This is not updated if neither state nore state attributes change. Example: `2017-10-28 08:13:36.715874+00:00`. |
