...
1. Under **Settings**, select the three dots menu (top right) <iconify-icon inline icon="mdi:dots-vertical"></iconify-icon>, select **Restart Home Assistant** > **Quick reload**.
