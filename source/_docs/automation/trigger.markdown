...
If you want to get more precise, start with the National Oceanic and Atmospheric Administration Solar calculation [tool](https://www.esrl.noaa.gov/gmd/grad/solcalc/) which will help you estimate what the solar elevation will be at any specific time. Then from this, you can select from the defined twilight numbers.
