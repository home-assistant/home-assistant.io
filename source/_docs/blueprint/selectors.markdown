...
When used without options, the selector will accept a free form object, array, list, string or any valid YAML types. The input box is displayed as an editor with syntax highlighting.
