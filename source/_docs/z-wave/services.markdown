...
| update_config          | Attempt to update OZW configuration files from git to support newer devices. After you run this, wait a few minutes then stop Home Assistant. You can now delete the relevant entries from your `zwcfg_*.xml` and start Home Assistant. |
