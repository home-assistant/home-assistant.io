...
- 700 series controllers (*Warning*: As of 15 January 2022 [users are still reporting stability problems with these controllers](https://github.com/zwave-js/node-zwave-js/issues/3906).)
  - Aeotec Z-Stick 7
  - Zooz ZST10 700
