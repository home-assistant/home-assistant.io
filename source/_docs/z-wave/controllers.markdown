...
If you are just starting out, we recommend that you purchase a 700 series controller or a Raspberry Pi module. SmartStart 700 series controllers are the more recent version, compared to the 500 series. They support SmartStart, which allows you to add a device by scanning a QR code.
