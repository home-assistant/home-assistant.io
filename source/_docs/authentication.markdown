...
If you have logged out, you will be asked for credentials before you can log in. If you login from within your local network, you will be greeted with a login screen showing all the people in Home Assistant.
...
When logging in from outside your local network, the users are not shown. This is to protect your privacy. In this case, you are greeted with a login screen asking you to enter the user name. This screen might also be shown if you are using a Chromium-based browser (Chrome, Edge) and IPv6. In this case, Home Assistant might not be able to detect if your are logging in from a local network. This is a known issue with Chromium.
