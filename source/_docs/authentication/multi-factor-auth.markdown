...
6. Your phone app will now start generating a different six-digit code every thirty seconds or so. 
7. Enter one of these into Home Assistant under the QR code where it asks for a **Code**.
