---
title: "Type conversion template functions"
description: "Template functions for converting and checking value types."
sidebar: false
feedback: false
---
...
{%- assign cat_functions = site.template_functions | where: 'category', 'type' | sort: 'function_name' -%}
