---
title: "Math template functions"
description: "Template functions for mathematical operations, statistics, and numeric calculations."
sidebar: false
feedback: false
---
...
{%- assign cat_functions = site.template_functions | where: 'category', 'math' | sort: 'function_name' -%}
