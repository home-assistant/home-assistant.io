---
title: "Comparison template functions"
description: "Template test functions for comparing values."
sidebar: false
feedback: false
---
...
{%- assign cat_functions = site.template_functions | where: 'category', 'comparison' | sort: 'function_name' -%}
