...
---
## Changes in 0.100.0
- 📣 [picture glance card]: Add tap/hold actions to entities (#3807) @iantrich
- 📣 [entities card]: add image option (#3832) @iantrich
- 📣 [picture glance card]: UI Editor (#3709) @iantrich
- 📣 [entity filter card]: Expand entity-filter options (#3692) @iantrich
- 📣 [history graph card]: UI Editor (#3782) @iantrich
- 📣 [light card]: icon option (#3771) @iantrich
