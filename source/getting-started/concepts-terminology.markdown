...
<p class='img'><img src='/images/getting-started/app-store.png' style='border: 0;box-shadow: none;' alt="Screenshot of the app page">Screenshot of the app store, showing all the installed apps on a test system.</p>
