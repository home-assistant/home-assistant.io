...
4. The most foolproof networking setup for your Raspberry Pi is to connect it using an Ethernet cable, however if you want to configure Wi-Fi or a static IP address (this step requires a USB stick) you can try this: (Note: Your milage may vary and Wi-Fi might not work even after taking these steps.)
