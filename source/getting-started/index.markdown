...
- A USB-Stick (optional, to configuration unattendend)
...
1. WiFi setup only: Format a USB-Stick with name `CONFIG` and copy one of [the example] to the file `network/hassos-wifi`.
...
[the example]: https://github.com/home-assistant/hassos/blob/dev/Documentation/network.md
