...
7. Next, we want to edit the weather card.
   ...
   - Then, select the cogwheel <iconify-icon inline icon="mdi:cog-outline"></iconify-icon>.
...
9. Next, we want to add a new card for this weather {% term service %}.
   - Select the weather card again, select the three dots <iconify-icon inline icon="mdi:dots-vertical"></iconify-icon>, then **Device info**.
