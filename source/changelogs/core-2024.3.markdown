...
- Bump opower to 0.3.0 ([@swartzd] - [#109248])
...
- Bump openwebifpy to 4.2.4 ([@autinerd] - [#110676])
...
- Revert "Fix Shelly RPC RSSI sensor removal ([@thecode] - [#111035])
...
- Bump roombapy to 1.6.13 ([@Orhideous] - [#111187])
