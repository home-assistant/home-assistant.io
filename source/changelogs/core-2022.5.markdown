...
- Add Template selector ([@frenck] - [#70229])
...
- Add update platform for Sensibo ([@gjohansson-ST] - [#70180]) ([sensibo docs]) (breaking-change)
...
- Add clear_skipped service to update entity ([@frenck] - [#70116]) ([update docs])
...
- Add update entity to fritz integration ([@Mask3007] - [#70096]) ([fritz docs]) (breaking-change)
...
- Add backup.create service ([@frenck] - [#70118]) ([backup docs])
...
- Add Sonos favorites sensor ([@jjlawren] - [#70235]) ([sonos docs])
- Add unique ID to scripts ([@frenck] - [#70345]) ([script docs])
...
- Add calendar event end trigger ([@allenporter] - [#70372]) ([calendar docs])
...
- Implement support for start_up_on_off in ZHA ([@dmulcahey] - [#70110]) ([zha docs])
...
- Add duration device class to sensor platform ([@bdraco] - [#70543]) ([sensor docs])
