...
tap_action:
  required: false
  description: Action to take on tap of row (does not apply to special rows)
  type: object
  keys:
    action:
      required: true
...
hold_action:
  required: false
  description: Action to take on tap-and-hold of row (does not apply to special rows)
  type: object
  keys:
    action:
      required: true
