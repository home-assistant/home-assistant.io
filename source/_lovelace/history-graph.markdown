...
hours_to_show:
  required: false
  description: Hours to show. Minimum is 1 hour. Big values can result in delayed rendering, especially if the selected entities have a lot of state changes.
  type: integer
  default: 24
refresh_interval:
  required: false
