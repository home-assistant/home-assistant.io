...
5. For state badges make sure your translation fits into the badge. To test this go to states (`<>`) and create a new entity with the id `device_tracker.test` and your translation as state.
