...
The **Vacuum is paused** condition passes when one or more targeted vacuums are paused in the middle of a cleaning run.
...
4. From the search box, search for and select **Vacuum: Vacuum is paused**.
