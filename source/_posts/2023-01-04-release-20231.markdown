...
- Reolink check for admin ([@starkillerOG] - [#85570]) ([reolink docs])
...
- Bump pySwitchbot to 0.36.4 ([@bdraco] - [#85777]) ([switchbot docs])
...
- Bump aiohomekit to 2.4.4 ([@bdraco] - [#85853]) ([homekit_controller docs])
- Skip over files without mime type in Jellyfin ([@j-stienstra] - [#85874]) ([jellyfin docs])
- Bump google-nest-sdm to 2.1.2 ([@allenporter] - [#84926]) ([nest docs])
- Bump google-nest-sdm to 2.2.2 ([@allenporter] - [#85899]) ([nest docs])
- Add a timeout during OAuth token exchange and additional debug logging ([@allenporter] - [#85911]) ([nest docs])
- Bump aiowebostv to 0.3.1 to fix support for older devices ([@thecode] - [#85916]) ([webostv docs])
...
- Bump aiowebostv to 0.3.2 ([@thecode] - [#86031]) ([webostv docs])
- Handle ignored shelly entries when discovering via zeroconf ([@bdraco] - [#86039]) ([shelly docs])
- Update pyTibber to 0.26.8 ([@Danielhiversen] - [#86044]) ([tibber docs])
