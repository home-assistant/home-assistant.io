...
Media Source is not limited to local media. Any integration can offer their media. [@cgtobi] has upgraded [the Netatmo integration](/integrations/netatmo) which will now offer its recorded motion events to play.
...
All icons that were deprecated in [0.113.0](https://www.home-assistant.io/blog/2020/07/22/release-113/#mdi-icons-updated) have now been removed. Icons that were renamed or deleted in version [5.0.45](https://dev.materialdesignicons.com/upgrade#4.9.95-to-5.0.45) will no longer work.
