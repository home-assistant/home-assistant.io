...
- Customize the sidebar
  - Improve / extend text
  - Animation or recording on how that works
- Person image upload
  - Improve / extend text
  - Animation or recording on how that work
- Template developer tools
  - Check text
  - Add animated gif on the live update
- Logbook
...
- User password change?
  - Either keep it and add some content + screenshot or move it to other noteworthy changes
...
- Order entities in Lovelace UI editor
  - improve / extend text
  - Needs gif animation of the moving action
...
we really wanted to polish before releasing it. The additional time this release
was very well spent.
...
- [Automation & Scripts updates](#automation--scripts-updates)
  ...
  - [Use input_* helper entities directly in your automations and scripts](#use-input_-helper-entities-directly-in-your-automations-and-scripts)
...
- [Logbook](#logbook)
- [Reload everything YAML and integration](#reload-everything-yaml-and-integration)
...
The MDI icons are updated to version [5.5.55](https://dev.materialdesignicons.com/changelog#version-5.5.55), this adds another 100 icons you can use!
...
All icons that were deprecated in [0.113.0](https://www.home-assistant.io/blog/2020/07/22/release-113/#mdi-icons-updated) have now been removed.
