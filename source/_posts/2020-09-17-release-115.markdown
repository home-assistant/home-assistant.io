...
- Issues with integrations, automations and such (Core releated):
...
- Social media image
- Bump version in Jekyll config
- Documentation page for new image integration is missing
- Image uploading

Not placed yet:

- Sidebar changeable, press and hold an item in the sidebar to activate edit mode.
- Reloading of platforms/Integrations, now available for:
...
- Something about the template changes? Mainly performance I guess.
...
- The OpenZwave beta integration in coming along nicely. First signs of
  some control panels in the UI are visible this release. Exposing more
  information in the UI of Home Assistant. Thanks [@cgtobi]!
