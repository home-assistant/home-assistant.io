...
- Happy birthday!
- Media browser and the integrations supporting it
- Tags!
- Automation & Scripts changes
  - shorthand template conditions
  - wait_for_trigger
  - use of input_datetime in triggers and conditions
  - more use if input_* in conditions
  - 
- Major WTH changes
  - Sidebar changeable
  - 
...
- [Lorem ipsum template][lorem ipsum docs], added by [@frenck]
...
- The **Lorem Ipsum** integration has been removed.
  Lorem has deprecated the Ipsum API.
  ([@frenck] - [#11111])
