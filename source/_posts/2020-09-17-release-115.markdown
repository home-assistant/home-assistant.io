...
This release, [@bdraco] found a way to reload some of internal integrations
...
As of this release, besides the integration that already could be reloaded,
...
This release brings an update to the way you can expose entities toGoogle
...
- The stream component now supports audio! And if you use the latest Home
  Assistant Android app, the stream component now supports H.265 streams.
