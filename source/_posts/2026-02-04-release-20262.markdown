...
- [@Sab44] added support for authentication to the [Libre Hardware Monitor] integration, allowing servers that require credentials to be monitored in Home Assistant.
