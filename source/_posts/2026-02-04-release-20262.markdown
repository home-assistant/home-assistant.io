...
By introducing it in Home Assistant Labs, we have also added a new section called **Device analytics** to {% my analytics title="**Home Assistant Analytics**" %}. If you opt in, you are, of course, able to opt out at any time.
...
Read our [blog post](https://www.home-assistant.io/blog/2026/02/02/about-device-database/) for more details and join the conversation in our Discord project channel; we’d love to hear your ideas, feedback, and questions as we shape this resource together.
...
- The area card now supports entities as control buttons, thanks to [@MindFreeze].
