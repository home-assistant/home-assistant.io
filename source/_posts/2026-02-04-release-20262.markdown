...
<img src='/images/blog/2026-02/distribution-card.png' alt='Screenshot of a the two distribution cards on a desktop, providing a new way of insight into your data.' class='no-shadow' />
...
The area card now lets you select individual entities as control buttons, not just entire domains. Previously, adding a light control meant showing all lights in the area. Now you can pick exactly which entities appear.
