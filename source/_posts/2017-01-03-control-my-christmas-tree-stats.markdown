...
![alt text](http://i.imgur.com/WMTQlrK.gif "Christmas Tree GIF")

During the time by tree was set up, I had 7,366 visitors from 88 countires connect to my Home Assistant instance with up to 16 concurrent viewers. This generated an estimated 100,000 clicks on the switches in my Home Assistant instance - thanks in part to some folks who posted up with macros for 6-8 hour stretches. 

![alt text](http://i.imgur.com/Nihl55m.png "View Counts")
