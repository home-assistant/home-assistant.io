...
These new badges match the functionality of the previous design, but bring in a number of new improvements. They are of course fully configurable from the UI, allowing you to
