...
We've taken that to heart, and today, we are introducing an easier way for new users to upgrade their smart homes to Home Assistant: the Home Assistant Green.
...
<div class="alert">
    <p><iconify-icon icon="mdi:lightbulb-outline"></iconify-icon> <strong>Note:</strong> updated on 24/04/2026 to reflect new price changes.</p>
</div>
