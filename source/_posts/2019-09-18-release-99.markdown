...
We going a step closer to Home Assistant and have one secrets store over the platform. You can now use `!secret my_value` also inside Add-on Options like you known from your YAML configuration.
