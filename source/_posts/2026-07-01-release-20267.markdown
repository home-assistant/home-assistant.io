---
layout: post
title: "2026.7 Beta: Automations that speak your language"
...
categories:
  - Release-Notes
  - Core
og_image: /images/blog/2026-07/beta-social.png
---
...
**Welcome to the beta release notes for Home Assistant 2026.7** 🎉
...
- [Report(ed) beta **dashboards/UI/frontend** issues](https://github.com/home-assistant/frontend/milestone/145)
- [Report(ed) beta **integrations/automations/backend/core** issues](https://github.com/home-assistant/core/milestone/819)
- [Report(ed) beta **documentation** issues](https://github.com/home-assistant/home-assistant.io/milestone/152)
...
<img src='/images/blog/2026-07/temp-automation-purpose-specific-trigger.png' alt='Screenshot of the automation editor showing the new purpose-specific triggers, described by what they do rather than their underlying state.' class='no-shadow' />
...
<img src='/images/blog/2026-07/temp-automation-area-target.png' alt='Screenshot of an automation built around motion in an area instead of a single sensor entity.' class='no-shadow' />
...
TODO: Add screenshot of an event entity trigger in the new situation
...
<img src='/images/blog/2026-07/temp-documentation.png' alt='Screenshot of a trigger documentation page, explaining what the building block does, how to use it in the UI, and how it looks in YAML.' class='no-shadow' />
...
<img src='/images/blog/2026-07/temp-activity-timeline.png' alt='Screenshot of the redesigned Activity timeline, with entries grouped by day on a vertical rail with colored state dots.' class='no-shadow' />
...
<img src='/images/blog/2026-07/temp-activity-compact.png' alt='Screenshot of the compact Activity timeline inside a more info dialog, showing the cause icon and trailing time.' class='no-shadow' />
...
<img src='/images/blog/2026-07/temp-update-all-grouped.png' alt='Screenshot of the redesigned Updates page showing pending updates grouped into cards.' class='no-shadow' />
...
- **[Alexa Devices]** gained switches to toggle announcements and communications on your Amazon Echo devices. Thanks, [@chemelli74]!
...
- **[Overkiz]** now supports fans. Thanks, [@iMicknl]!
...
<img src='/images/blog/2026-07/temp-time-format.png' alt='Screenshot of the tile card editor showing the new Time format option for a timestamp entity.' class='no-shadow' />
...
<img src='/images/blog/2026-07/temp-infrared-rf-panels.png' alt='Screenshot of the new infrared and radio frequency panels in the Settings menu, each listing the configured proxies.' class='no-shadow' />
...
<img src='/images/blog/2026-07/temp-zha-device-management.png' alt='Screenshot of the revamped ZHA device management page, with a device summary card and tabbed navigation for clusters, bindings, signature, and neighbors.' class='no-shadow' />
...
This is more than a nice-to-have. Your Pi's firmware needs to stay compatible with the Linux kernel that ships in Home Assistant Operating System, and as that kernel moves forward, older firmware can start to hold it back. Until now, updating that firmware was cumbersome: you had to flash another SD card with a special image, or connect a keyboard and a display and run the `rpi-eeprom-update` command by hand. Now it is a single selection.

<img src='/images/blog/2026-07/temp-rpi-firmware-update.png' alt='Screenshot of the Raspberry Pi firmware update entity on the Settings, Updates page.' class='no-shadow' />

A few things to keep in mind:

- This needs [Home Assistant Operating System 18](https://github.com/home-assistant/operating-system/releases/tag/18.0) or newer and Home Assistant Supervisor 2026.06.0 or newer, which provide the support the update entity builds on. On older versions, the entity simply isn't there.
- On a Raspberry Pi 4, the firmware can only be updated when the board boots from an SD card. If your Pi 4 boots from USB storage, the update isn't available. This is one more reason we recommend using USB only as a data disk and keeping an SD card as the main boot device.
- Not every board can update its firmware this way. Where an update can't be applied, the entity doesn't appear at all, so you shouldn't see an option that wouldn't work.
- After the update is applied, Home Assistant prompts you to reboot the board to finish.

There is a bit of irony here worth being candid about. Outdated firmware on some installations is exactly what led us to hold Raspberry Pi 5 and Home Assistant Yellow back from Operating System 18.0 for now. The new update entity is part of how we make it straightforward to get that firmware current, and we expect the issues that led to rolling that release back to be resolved in the upcoming 18.1 patch release.
