---
layout: post
title: "2026.7 Beta: A betta title"
...
<img src='/images/blog/2026-07/temp-automation-documentation.png' alt='Screenshot of a trigger documentation page, explaining what the building block does, how to use it in the UI, and how it looks in YAML.' class='no-shadow' />
...
We've all been there. You open **Settings** > **Updates** after being away for a bit, and there it is: a wall of pending updates. A new Home Assistant release, a handful of {% term "add-on" "add-ons" %}, that one integration, and seven ESPHome devices that all decided to ship new firmware in the same week. Keeping up used to mean working down that list one entry at a time, selecting, waiting, selecting the next, and repeating until your finger got tired.
...
- **Apps** does the same for your add-ons.
...
- **Snappier templates.** Under the hood, a template engine optimization makes templates render up to 40% faster.
...
<img src='/images/blog/2026-07/temp-time-format-selection.png' alt='Screenshot of the tile card editor showing the new Time format option for a timestamp entity.' class='no-shadow' />
...
- If you use the Z-Wave JS add-on, update it to at least version 1.4.0.
