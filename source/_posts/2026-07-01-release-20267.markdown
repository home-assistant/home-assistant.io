...
- **A Raspberry Pi firmware update entity.** Running Home Assistant on a Raspberry Pi? You can now keep its firmware up to date from within Home Assistant. Thanks, [@sairon]!
