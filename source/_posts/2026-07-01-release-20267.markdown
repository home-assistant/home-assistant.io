...
- This needs [Home Assistant Operating System 18](https://github.com/home-assistant/operating-system/releases/tag/18.0) or newer, which provide the support the update entity builds on. On older versions, the entity simply isn't there.
...
- After the update is applied, Home Assistant prompts you to reboot your system to complete the update.
