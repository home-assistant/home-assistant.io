...
---
_The Supervisor is shipped with our Home Assistant Operating System and controls all hardware and software on your device. Bringing an effortless experience in managing, upgrading and maintaining your Home Assistant instance. It provides single-click upgrades for the Operating System and Home Assistant Core, but also provides easy to use and install add-ons and allows users to easily manage it via the Home Assistant User interface. It is what allows you to focus on what really matters; automating your home._
