...
og_image: /images/blog/2025-05-roadmap-2025h1/art.png
---
...
It's been a year since we launched [our first roadmap](/blog/2024/06/12/roadmap-2024h1/) for Home Assistant, which means it's time for our annual update! This year, we're building on our direction to make Home Assistant easier to use for everyone in your household, and taking it to the next level by making smart homes more intuitive, proactive, and user-friendly. 🚀
...
Think of it as a source of truth created, curated, and validated by the community. A place where we gather everything from metadata (like power usage or infrared codes) to factual information (setup instructions such as how to add or reset a device) to real-world setup insights and community creations (such as automation examples).
