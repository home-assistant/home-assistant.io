...
A brand new, expiremental, view has been added this release: Sections!
...
If you are using [Home Assistant Cloud](https://nabucasa.com), you can acccess
...
you can enable the Remote UI feature remotely, by logging in into your Nabucasa
account, and request your Home Assistant instance to turn it on.
