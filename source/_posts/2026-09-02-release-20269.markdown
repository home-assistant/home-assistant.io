...
<img src='/images/blog/2026-09/tile-card-feature-light-effect.png' alt='Screenshot of the tile card feature editor, showing the light-effect feature added to a light entity, with a preview.' class='no-shadow' />
...
<img src='/images/blog/2026-09/tile-card-feature-vacuum-fan-speed.png' alt='Screenshot of the tile card feature editor, showing the vacuum-fan-speed feature added with a fan speed selector.' class='no-shadow' />
...
<img src='/images/blog/2026-09/tile-card-inline-features.png' alt='Screenshot of two tile cards with an inline feature next to the name and more features below it.' class='no-shadow' />
...
<img src='/images/blog/2026-09/serial-panel.png' alt='Screenshot of the new Serial panel, with a status banner at the top and the connected and available serial ports, showing which integration and app use each one.' class='no-shadow' />
