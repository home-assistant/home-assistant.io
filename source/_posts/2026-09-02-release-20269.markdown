...
- **[OwnTone]** added join and unjoin support, so you can group and ungroup multi-room audio zones directly from Home Assistant instead of the OwnTone web interface. Thanks, [@JanGiese]!
...
- **[Hot Spring]** added binary sensors for heating, spa connectivity, and problems, so you can tell at a glance whether the spa is heating, still talking to its Wi-Fi module, and free of faults. Thanks, [@Moustachauve]!
