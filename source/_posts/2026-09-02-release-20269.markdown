...
<img src='/images/blog/2026-09/temp-cloud-signup.png' alt='Screenshot of the redesigned Home Assistant Cloud start page, with a button to start a free trial, a link to sign in, and an overview of what Home Assistant Cloud offers.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-security-dashboard-favorites.png' alt='Screenshot of the Security dashboard editor, showing the favorite entities and the active alert entities with their severity levels.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-history-filtering.png' alt='Screenshot of the History page with the new Sources panel open, showing an area selected with 189 matching entities.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-activity-filtering.png' alt='Screenshot of the Activity page with the new Sources panel open, filtering activity down to motion sensors.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-activity-details.png' alt="Screenshot of the Activity details dialog for a cover, showing the automation and person that triggered its state change." class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-matter-network-graph.png' alt='Screenshot of the Matter network visualization page, showing Home Assistant connected through Thread border routers and a Wi-Fi access point to routers, end devices, and an offline device.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-tile-card-feature-light-effect.png' alt='Screenshot of the tile card feature editor, showing the light-effect feature added to a light entity, with a preview.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-tile-card-feature-vacuum-fan-speed.png' alt='Screenshot of the tile card feature editor, showing the vacuum-fan-speed feature added with a fan speed selector.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-tile-card-humidity-target.png' alt='Screenshot of the tile card feature editor, showing the target humidity feature added to a climate entity.' class='no-shadow' />
...
- **[UniFi Protect]** can now be set up with just an API key from your UniFi OS Console, no local user account needed, which helps on consoles where a local user cannot be created, such as sites enrolled in a UniFi Fabric. Pick **API key only (limited feature set)** when adding the integration, or switch an existing entry over at any time. This is the first part of the public API migration you can actually use, and it is still a small slice: the alarm panel, cameras with their streams and snapshots, and lights, while the sensors, switches, selects, events, and media browsing around them continue to need a local user, with more platforms following as they move over. Thanks, [@RaHehl]!
...
<img src='/images/blog/2026-09/temp-serial-panel.png' alt='Screenshot of the new Serial panel, showing connected, available, and disconnected serial ports and what uses each one.' class='no-shadow' />
...
<img src='/images/blog/2026-09/temp-network-storage-space.png' alt='Screenshot of the Storage page listing several network mounts, with usage bars showing how full each one is.' class='no-shadow' />
