...
If you want the value being sent to KNX right away, that's an optional configuration now. No matter if the expose was initialized before or after the exposed entity became available.
