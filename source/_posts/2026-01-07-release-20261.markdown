...
- [@farmio] expanded the [KNX] UI configuration to support time, date, and datetime entities, as well as sensor entities, making it easier than ever to set up your KNX installation.
