...
On often reported issue/request feature is to allow any discovered item to
...
It often caused not working TTS, streaming issues for camera's or issues with
...
<p class='img'>
<img src='/images/blog/2020-05-0.110/not_condition.png' alt='Screenshot from HomeKit. Left: accessory information, Right: Camera support.'></a>
...
in the system tab now (requires expert mode).
...
Some advanced add-ons are now also marked "expert" and are only visible when
...
- The ISY994 got a major upgrade! While it has quitea few breaking changes, it
...
- **Universal Devices ISY994** - This migrates ISY994 to PyISY v2 and is now
  ...
  <details>
    <summary>Click see all breaking change for ISY994</summary>
