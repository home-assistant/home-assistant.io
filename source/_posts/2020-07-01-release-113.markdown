...
## Breaking Changes
 ...
 <details><summary><b>Philips Hue</b></summary>
 <p>
 ...
 <details><summary><b>InfluxDB</b></summary>
 <p>
 
  Support added for glob matching in InfluxDB filters.
 ...
 <details><summary><b>Logitech Harmony Hub</b></summary>
 <p>

  Make devices and activities visible as harmony attributes
  The current activity is now updated as soon as the remote starts the activity change instead of being delayed until the activity is finished setting up.

  ([@bdraco] - [#37559]) ([harmony docs]) 
  </p>
  </details>
 <details><summary><b>Xiaomi Miio</b></summary>
 <p>

  Fan and remote components now have unique LED strings.
  If you had previously set your automation calls from "**fan**_set_led_on/off" to "**remote**_set_led_on/off", you will now need to set those back to "fan".

  ([@alexhardwicke] - [#37605]) ([xiaomi_miio docs]) 
  </p>
  </details>
 <details><summary><b>Samsung SyncThru Printer</b></summary>
 <p>

  Syncthru configuration is now done throught the integrations UI page.

  ([@scop] - [#36690]) ([discovery docs]) ([syncthru docs]) 
  </p>
  </details>
 <details><summary><b>Relative time</b></summary>
 <p>
 ...
 <p>
  ...
  Re-added the ability to use remote files (by URL) in Slack messages. The data schema for sending files in Slack messages has changed, so be sure to update any Slack-related service calls with the new schema: https://www.home-assistant.io/integrations/slack
  
  ([@bachya] - [#37161]) ([slack docs]) 
  </p>
  </details>
 <details><summary><b>Automations/Scripts</b></summary>
 <p>
  ...
  It also provides new "modes" of operation for these action sequences, namely single, restart, queued & parallel. To minimize the impact on existing automations and scripts, the default mode for automations is parallel, and the default mode for scripts is single. See the documentation for detailed descriptions of these modes.
  
  In addition, for queued & parallel modes there is now a new config option -- max -- that controls the maximum number of "runs" that can be executing and/or queued up at a time. And lastly, the delay step is now much more precise, and supports delays of less than one second. 

  ([@pnbruckner] - [#37729]) ([automation docs]) ([script docs]) 
  </p>
  </details>
 <details><summary><b>RFXCOM RFXtrx</b></summary>
 <p>
  
  * Configuration of rfxtrx devices now happens through the Integration UI page. Please see the documentation at https://www.home-assistant.io/integrations/rfxtrx/
  ...
  * The events format has changed. Please see the documentation at: https://www.home-assistant.io/integrations/rfxtrx/#events
 ...
 <details><summary><b>Fibaro</b></summary>
 <p>
