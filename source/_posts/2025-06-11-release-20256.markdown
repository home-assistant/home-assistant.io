...
- [Clearer Bluetooth networks](#clearer-bluetooth-networks)
...
Pickers are those dropdowns you use to select entities, devices, areas, and more. Pickers are *everywhere* in Home Assistant: automations, scripts, and configuration options.
