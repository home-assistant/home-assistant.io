...
description: "Great new Bluetooth connection graphs, all pickers have been revamped, sidebar management improvements, (un)group media players straight from you dashboards, and more!"
...
Anyway, the June release is here! A week later that usual, but it also means we had an extra week to polish and beta test this release. Like the [previous release](/blog/2025/05/07/release-20255/), this release is packed with quality-of-life improvements!
...
<img class="no-shadow" alt="Screenshot showcasing the new Bluetooth connection graph; Even Bluetooth proxies are show in the map." src="/images/blog/2025-06/bluetooth-connection-graph.png" />
