---
layout: post
title: "2021.10.0: Beta release notes"
description: "Beta release notes for Home Assistant Core 2021.10.0"
...
These are the beta release notes for Home Assistant Core 2021.10 (and is thus a
work in progress).
...
TODO:
- Make these nice :)
- Some might need their own chapter.
- MDI icons might need a breaking change section?
- Go over all commits again, likely I missed some...
...
- [Crownstone][crownstone docs], added by [@abmantis]
- [WattTime][watttime docs], added by [@bachya]
- [Whirlpool][whirlpool docs], added by [@abmantis]

## Integrations now available to set up from the UI

The following integrations are now available via the Home Assistant UI:

- [Lorem][lorem docs], done by [@frenck]
...
new integration will be officially maintained by the Tuya Developer Team, for
more information of the migration, please check this documentation
...
- **Trackr** has been removed. The API is no longer available and
  the integration has therefore been removed. ([@FuzzyMistborn] - [#55917])
