...
With Supervisor 231, shipped with Home Assistant 0.114, we added a new option on System Panel. 
If you want this, you need enable it, default it's disabled.
This will allow us to fix the problems, the information is only accessible to the 
Home Assistant Core team and will not be shared with others.
The data does not include any private/sensetive information and you can disable 
