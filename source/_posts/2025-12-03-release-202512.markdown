...
- **[Cosori]**, added by [@joostlek]  
  Support for Cosori devices is now available via the VeSync integration.
...
- **[VÁGNER POOL]**, added by [@lmaertin]  
  Support for VÁGNER POOL water treatment devices is now available via the SEKO PoolDose integration.
