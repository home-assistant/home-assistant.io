...
No more deep-diving into app settings! The **Add to** option appears in the more information dialog with actions tailored to the entity type. For example, adding a media player widget is only available for media players.
