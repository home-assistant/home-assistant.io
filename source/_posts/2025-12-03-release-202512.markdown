...
Our beloved {% term "Energy dashboard" %} just got a serious upgrade! After years of helping you track your electrons and gas molecules, we figured it was time to bring some more friends to the party: **real-time power monitoring** and **downstream water tracking**.

### Power: Because knowing what happened yesterday is so... yesterday

Until now, the Energy dashboard was all about energy - the cumulative kWh you've consumed or produced over time. But sometimes you want to know what's happening _right now_. How much power is that suspicious appliance actually pulling? Is your solar system earning its keep at this very moment?

With this release, you can now configure **power sensors** alongside your energy sensors. Track your real-time grid consumption, see how much you're exporting back to the grid, and watch those watts flow in real-time with the new power graphs.

Power configuration options now appear alongside energy settings for each source or device.

New power graphs have been added so you can enjoy watching your power consumption dance throughout the day.
...
Got a smart irrigation controller? A water softener with a flow meter? A separate meter for your pool? Now you can track them all and see exactly how your water consumption splits across different uses.

And because we couldn't leave water users without some eye candy, there's a brand new **water sankey card** that visualizes your water flow just like the energy sankey diagram you know and love. Watch your water consumption branch out to all its destinations in a satisfying visual flow.

<p class='img'>
<!-- TODO: Add screenshot of water sankey card -->
...
The new water sankey card shows where your water went at a glance.
</p>
