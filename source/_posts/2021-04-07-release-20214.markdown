...
Ludeeus did an amazing job writing this new integration. You decide if you turn
it on or not; however, we guarantee its privacy aware. Doubt it? Review it!
...
Extensive breaking changes have been made to the events generated by Z-Wave JS.
Automation triggers currently listening to the `zwave_js_event` event will need
to be update.  See the documentation for information on working with the new events:
<https://rc.home-assistant.io/integrations/zwave_js/#events>
