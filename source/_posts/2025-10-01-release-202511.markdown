...
- [Progress for Core and Add-on updates](#progress-for-core-and-add-on-updates)
...
## Progress for Core and Add-on updates

With this Home Assistant Core and Add-on updates (handled by the Supervisor) now have progress information! The progress includes download and unpacking of the update, hence the steps depend on the speed of your Internet connection and your CPU and its load. This makes the progress not completely linear. The progress still gives a rough estimate how long along the update is.
