...
- **[Smart Meter B Route]**, added by [@SeraphicRav]  
  Integrate your Smart Meter using the B Route protocol, primarily for the Japanese market and get real-time energy consumption data from your smart meter.
- **[Cync]**, added by [@Kinachi249]
  Integrate your Cync smart devices from GE Lighting, including smart lighting, into Home Assistant. Cync was formerly known as "C by GE".
