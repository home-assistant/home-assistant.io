...
As we start the New Year, we'd like to encourage you to make a resolution to regularly back up your important data. The great thing about this resolution is that it only takes about 5 minutes, thanks to the new automated and off-site backup features in [the latest release of Home Assistant](/blog/2025/01/03/release-20251/).
