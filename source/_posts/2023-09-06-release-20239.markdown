...
When setting up a helper, sometimes it can be useful to see how the entity that you are creating looks while you are setting it up. That's why we added an preview when you create or change a group helper.
