...
It now has a newly designed circular slider showing the current and target temperatures and allows you to easily swipe to the desired target temperature. And allows you to swipe to the desired target temperature easily.
...
A new entity type was added to release: the lawn mower!

You can now integrate your lawn mower into Home Assistant!
Never worry about the lawn mower when it starts raining, you can now automate it to stop and go back when it rains.
...
This will make it possible to have on-demand forecasts, that update when you want them to, instead of them being updated all time. 
...
Something you probably have not seen for a while, but we gave our onboarding a fresh new look! It is shortened to get the user in Home Assistant as fast as possible, so they can enjoy tinkering with their home faster!
