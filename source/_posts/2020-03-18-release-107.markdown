...
- Initial support for HomeKit enabled televisions was added by [@Jc2k].
- [@tulindo] added support for newer SamsungTV models.

## New Integrations

**TODO**: There are more new integrations, this section need an update after cutting the beta.
...
**TODO**: Ensure we have all breaking changes after beta is cut.
...
**TODO**: This section need to be updated to match the beta, after the code base has been cut.
