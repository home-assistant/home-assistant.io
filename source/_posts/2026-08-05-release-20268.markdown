...
ADDED to the list: Google Health (#175417), llama.cpp (#175580), GeoSphere Austria Warnings (#173563), Dyson Infrared (#173666).
HELD (not in 2026.8):
- Flic Button (#165260, @alhia) — merged to the `flic2` feature branch, not dev; docs PR #44011 still open, so no /integrations/flic_button page. Revisit when it lands in dev with merged docs.
-->
...
<!-- TODO REMOVE BEFORE FINAL. Backward-incompatible changes processed up until PR #177187 (sweep 1); sweep 2 (2026-07-31) added AirNow (#176740) and Edifier Infrared (#177472).
...
AirNow #176740 confirmed 2026.8 (appears in the 2026.8.0b0 release tag). -->
