---
layout: post
title: "2026.8: Approachable by design"
description: "A more approachable Home Assistant: less technical jargon, easier web server settings, a redesigned Home Assistant Cloud page, simpler entity ID renaming, cleaner device management, more triggers and conditions, and new integrations!"
...
categories:
  - Release-Notes
  - Core
og_image: /images/blog/2026-08/social.png
---
...
<a href='https://youtube.com/live/aK2HMY9-Tzo'><img src='/images/blog/2026-08/ESPH-2607-starterkit-livestream-thumbnail.png' alt='ESPHome Starter Kit launch party livestream on August 12' class='no-shadow' style='float: right; width: 40%; max-width: 340px; margin: 0 0 8px 16px;' /></a>
There's more to look forward to next week: the **ESPHome Starter Kit** is launching, and you're invited to the official launch party! 🚀 Join the ESPHome team and their partners at Apollo Automation on the [ESPHome YouTube channel](https://youtube.com/live/aK2HMY9-Tzo) on August 12 at 21:00 CEST. Familiar faces are dropping by to celebrate lift-off, too: [Reed](https://www.youtube.com/c/SmartHomeSolver) from Smart Home Solver, [Simon](https://www.youtube.com/@simonsayshomeassistant) from Simon Says Home Assistant, and [Gavin](https://www.hometech.fm/) from HomeTech.fm.
...
- [Other noteworthy changes](#other-noteworthy-changes)
  ...
  - [Z-Wave lock credentials, properly managed](#z-wave-lock-credentials-properly-managed)
  - [And a few more](#and-a-few-more)
- [Patch releases](#patch-releases)
  - [2026.8.1 - August 7](#202681---august-7)
  - [2026.8.2 - August 14](#202682---august-14)
...
- **[GeoSphere Austria Warnings]**, added by [@tklecka]  
  Bring official weather warnings for Austria into Home Assistant from [GeoSphere Austria](https://www.geosphere.at) (formerly ZAMG), the national weather service. Warnings are issued per municipality and cover events like storms, heavy rain, snow, black ice, thunderstorms, heat, and cold, so you can get notified or trigger automations when the warning level rises.
...
[Dyson Infrared]: /integrations/dyson_infrared
[Fuelprices.dk]: /integrations/fuelprices_dk
[Gatus]: /integrations/gatus
[GeoSphere Austria Warnings]: /integrations/geosphere_austria_warnings
...
On the picture elements card, a tap could trigger the element next to the one you meant, or hit nothing at all, and some elements could not be tapped. Taps now go to the nearest icon or label, so every element can be reached, and tapping a label's text always triggers that label. Thanks, [@RaHehl](https://github.com/RaHehl)!
...
<img src='/images/blog/2026-08/favorite-cards.png' alt='Screenshot of the card picker&apos;s By Card tab, with the Tile, Area, and Entities cards marked as favorites with a star icon.' class='no-shadow' />

Thanks, [@piitaya], [@laupalombi](https://github.com/laupalombi), and everyone who suggested this at a Release Party!
...
<p class='img'>
  <img class='no-shadow' src='/images/blog/2026-08/zwave-access-control.png' alt='The new Access Control tab in Z-Wave JS UI, showing users and their credentials'>
...
If you would like to wear your support: the Open Home Foundation store just added new T-shirts featuring ESPHome, Music Assistant, and a fresh Home Assistant design, all in classic black (or Dark Mode, if you prefer!). They are versatile, built to last, and best of all, every purchase helps fund the foundation's work. [Grab yours from the store](https://store.openhomefoundation.org/shop/t-shirts).

<a href='https://store.openhomefoundation.org/shop/t-shirts'><img src='/images/blog/2026-08/Black-shirts-newsletter.png' alt='Three black T-shirts from the Open Home Foundation store, featuring the ESPHome, Music Assistant, and Home Assistant designs.' class='no-shadow' /></a>
