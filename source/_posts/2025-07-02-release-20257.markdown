...
- [Google Generative AI] now supports text-to-speech (TTS) with 30 voices and 24 languages. It supports fine-grained control over style and sound, e.g. "Say cheerfully: Have a wonderful day!". Thanks [@lanthaler]!
