...
_Huge thanks to [@jlpouffier](https://github.com/jlpouffier) for the amazing work on the roadmap and everyone who had given feedback to us throughout the entire process._

<!--more-->

## Home Assistant: “A Home-Approved Smart Home”

<p><img src='/images/blog/2024-06-roadmap-2024h1/ha-roadmap-2024h1.png' class='no-shadow' alt="[Home Assistant Roadmap 2024 H1"/></p>
