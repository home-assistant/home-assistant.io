...
We realize it is invoking concern of future ads and that it could have had a better execution. In fact, within some of the (yes, sometimes heated) discussion about it during the beta, there were some good thoughts and examples shared for working toward a truer "community news" integration which can pull in future and ongoing community events, news, and project highlight which could be enabled or disabled like any other integration...but for now it is this banner which will be removed on the next release.
...
Per ADR-0010, this release deprecates YAML configuration for Flu Near You
until 0.119.
...
- Deprecate ptvsd integration ([@frenck] - [#42351]) ([ptvsd docs]) (breaking-change)
