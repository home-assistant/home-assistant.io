...
- [Take full control over Blueprint automations](#take-full-control-over-blueprint-automations)
...
<p class='img'>
    <img src="/images/blog/2024-07/datatables-customize-columns.png" alt="Screenshot of..."/>
    Temporary mockup, image needs to be replaced by an actual screenshot.
</p>
...
You customized columns and view, is stored in your browser, so you only have to
set it up once, and it will be remembered for the next time you visit the page.

## Take full control over Blueprint automations

{% term Blueprints %} are amazing, it allows you to use {% term automations %}
created and shared by other awesome Home Assistant users. Most are easy to use
and set up, but what if that great blueprint you've been using just needs a
little tweak? Just that tiny change to make it perfect for your home?
...
_TODO: Insert screenshot or screen recording_
...
- Bang & Olufsen add overlay/announce play_media functionality ([@mj23000] - [#113434]) ([bang_olufsen docs])
- Add Tidal play_media support to Bang & Olufsen ([@mj23000] - [#119838]) ([bang_olufsen docs])

- Add event entity to Nanoleaf ([@joostlek] - [#120013]) ([nanoleaf docs]) (new-platform)

- Add support for Switchbot Lock Pro ([@szclsya] - [#119326]) ([switchbot docs]) (noteworthy)
- Add price service call to Tibber ([@basbruss] - [#117366]) ([tibber docs])
...
- Add support for the DS18B20 temperature sensor to Nettigo Air Monitor integration ([@bieniu] - [#118601]) ([nam docs])
- Add HDR type attribute to Kodi ([@starkillerOG] - [#109603]) ([kodi docs])
...
- Add button platform to Husqvarna Automower ([@Thomas55555] - [#119856]) ([husqvarna_automower docs]) (new-platform)
- Add extra sensor to the Jewish Calendar integration ([@gedaliahknizhnik] - [#116734]) ([jewish_calendar docs])
...
- Add tado climate swings and fan level ([@EtienneSOU] - [#117378]) ([tado docs])
...
The following {% term integration %} reached the platinum 🏆 level on our
...
Congratulations to all the developers who worked on this integration!
