...
- **[MTA New York City Transit]**, added by [@OnFreund]  
  Get real-time subway arrival predictions for all NYC subway lines using data from the [Metropolitan Transportation Authority (MTA)](https://new.mta.info/).
...
- **[Anthropic Conversation]** now supports the Claude Opus 4.6 model with adaptive thinking effort levels, and gained native structured outputs for more accurate tool calls on models 4.5 and newer. Thanks, [@Shulyaka]!
...
- **10 integrations reached silver** 🥈
  ...
  - [MTA], thanks to [@OnFreund]
  - [NRGkick], thanks to [@andijakl]
  - [Teslemetry], thanks to [@Bre77]
  - [Teltonika], thanks to [@karlbeecken]
  - [Velux], thank to [@wollew]

- **8 integrations reached bronze** 🥉
  - [Aladdin Connect], thanks to [@JamieMagee]
  - [Anthropic Conversation], thanks to [@Shulyaka]
