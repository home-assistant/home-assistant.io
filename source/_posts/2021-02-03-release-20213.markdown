...
- Server version requirement for Home Assistant core 2021.3.0:
...
- Config parameter service: [zwave_js.set_config_parameter](/integrations/zwave_js/#service-zwave_jsset_config_parameter)
  You're now able to automate and change the configuration settings of your devices with this service.
- Refresh value service: [zwave_js.refresh_value](/integrations/zwave_js/#service-zwave_jsrefresh_value)
  You can now configure an automation to use the refresh_value service to update a device that doesn't automatically refresh itself.
- Barrier cover support (garage doors).
  Garage doors and similar covers can now be controlled in the integration.
- Number platform
