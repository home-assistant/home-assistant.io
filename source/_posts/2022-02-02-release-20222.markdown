...
If you use `default_config:` in your configuration, you get this feature for free. If you don't, you can add it to your installation by adding the `diagnostics:` directive to your configuration and restarting.
