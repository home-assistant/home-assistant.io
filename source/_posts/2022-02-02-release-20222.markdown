...
opens the [Quick Bar](/docs/tools/quick-search/). This also works on mobile devices.
...
...don't hesitate to use our very active [forums](https://community.home-assistant.io/) or join us for a little [chat](https://discord.gg/home-assistant).
