...
For the Plugwise Adam, all device-based climate-entities will be replaced by new zone-based climate entities, most likely with a different name.
This change is needed because recently (via Issue #130597) it became clear that in the Plugwise App, the climate-entities are representing a climate zone.
