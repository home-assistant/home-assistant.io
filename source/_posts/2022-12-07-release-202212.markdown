...
- [Local calendar (tbd, not merged yet)](#local-calendar-tbd-not-merged-yet)
- [Bluetooh proxy using Shelly devices](#bluetooh-proxy-using-shelly-devices)
...
- Iterate story
- Spelling/grammar
- Fan speed isn't merged yet, might not make it?
  <https://github.com/home-assistant/frontend/pull/14474>
- Docs not merged yet
  <https://github.com/home-assistant/home-assistant.io/pull/25080>
...
- Slider to control the speed of fans

_TODO: below needs a link_

[Checkout the our documentation for more information about Tile features](#lorem)

## Local calendar (tbd, not merged yet)

Note: This feature will probably not make it this release.
...
- Spelling/grammar
- Screenshots
- Unsure if this is making .12, awaiting frontend?
...
## Bluetooh proxy using Shelly devices
