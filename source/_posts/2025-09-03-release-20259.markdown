...
One superpower of the tile card is its “features”, which are small additions where you can add quick interaction to these cards. For example, a slider to control the brightness of a light or the speed presets for a fan. Features have been extended quite a bit in this release by a dedicated group of community members.

### History chart

This release, an absolute banger is the addition of the history chart features for tile cards created by [@MindFreeze].
...
This release adds disk metrics to the [storage configuration panel](https://my.home-assistant.io/create-link/?redirect=storage), letting you see usage at a glance, helping you identify what is taking up space.
