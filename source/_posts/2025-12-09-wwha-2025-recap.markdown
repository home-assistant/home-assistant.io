...
If you’re ever in need of a device that works great with Home Assistant, *well, I have a program for you*. [Works with Home Assistant](https://works-with.home-assistant.io/) is our certification program that ensures devices work seamlessly and locally, all with brands that back them up.
...
This means our testers aren’t overwhelmed with a truckload of devices delivered to their door in order to launch one partner. Also, if a manufacturer has one device that is cloud-controlled, it doesn’t blacklist any remaining items they have that could operate perfectly well locally. It also means that sometimes your favorite devices aren’t part of the first wave of certification but, trust us, the partners check the comments 😉.
