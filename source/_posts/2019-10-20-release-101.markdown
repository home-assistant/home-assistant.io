...
Highlight breaking change for api password/trusted networks

https://www.home-assistant.io/blog/2019/10/26/rip-hassbian/

## Frontend

A lot has happend on the frontend, we had a ton of Hacktoberfest PR's that added lokalization to the frontend and made our user experience better.
...
The device automation trigger editor now has duration support, so it will only trigger if a device is in a certain state for a set duration.
...
https://twitter.com/Frenck/status/1188044714571907072?s=09
