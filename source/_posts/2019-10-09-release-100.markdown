...
* Fix dark switch for map card editor (#3856) @bramkragten
* Align background with tiles (#3858) @bramkragten
* Allow yaml in dev states (#3859) @bramkragten
* Allow yaml in dev services (#3860) @bramkragten
* Allow yaml in dev events (#3861) @bramkragten
* Allow yaml in script and automation (#3862) @bramkragten
* Default hide disabled entities from entity registry (#3863) @bramkragten
* Guard for null badges (#3841) @bramkragten
* Add entity registry functions to device page (#3843) @bramkragten
* Allow user selection of text in Lovelace (#3605) @iantrich
* Update documentation link URL for integrations (#3857) @frenck
* add actions to picture-glance entities (#3807) @iantrich
* Fix some styling of ha-switch (#3842) @bramkragten
* Remove local mdc-datatable (#3840) @bramkragten
* Add missing domain icons (#3836) @SeanPM5
* Use filter worker in data-table (#3808) @bramkragten
* add image option to entities card (#3832) @iantrich
* fix alignment of switches positioned absolutely (#3812) @iantrich
* add state_filter to picture cards (#3791) @iantrich
* Add a setting for vibration (#3813) @bramkragten
* Add hassio supervisor and os update notice (#3798) @bramkragten
* Add name to picture entity struct (#3809) @bramkragten
* UI Editor for picture-glance card (#3709) @iantrich
* Fix firefox overflow (#3806) @bramkragten
* Expand entity-filter options (#3692) @iantrich
* Green shade in climate history for platforms that don't support `hvac_action` (#3787) @OnFreund
* UI editor for history-graph (#3782) @iantrich
* cleanup editors (#3786) @iantrich
* Add support for `and` and `or` conditions to the automation editor. (#3724) @emontnemery
* Add support for panels to cast (#3796) @bramkragten
* Move views to own folder + use update vs updated in panel view (#3761) @bramkragten
* Add Language Urdu (#3750) @bramkragten
* Add support for automation description (#3723) @emontnemery
* light-card: icon option (#3771) @iantrich
* Switch paper-toggle-button to mwc-switch (#3683) @iantrich
* Upgrade some deps (#3780) @balloob
* UI Editor for picture-entity card (#3708) @iantrich
* picture entity editor fix (#3783) @iantrich
* new action: url (#3773) @iantrich
* Replace all default exports in common/ with named exports (#3790) @iantrich
* Add device automation options to device page (#3776) @bramkragten
