...
We created a [mockup](https://www.figma.com/file/4LZqQZRynDZGTgA2rN35Te/Home-Assistant-config-mockup?node-id=0%3A1) of how we want our configuration panel to look like and will be working towards that the coming time.
This release we implemented the config sections and tabs as well as some visual tweaks.
