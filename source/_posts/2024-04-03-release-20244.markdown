...
<img class="no-shadow" src='/images/blog/2024-04/labels.png' alt='Screenshots showing the new map dashboard you can add when you add a new dashboard to your Home Assistant.'>
