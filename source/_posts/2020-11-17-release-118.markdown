...
date_formatted: "November 17, 2020"
...
These are the beta release notes for Home Assistant 0.118.0.
...
- [Espon][epson docs], done by [@pszafer]
...
- The **Lorem ipsum** integration has been removed.
...
- Migrate system health to use integration_platform ([@balloob] - [#42785]) ([lovelace docs]) ([system_health docs]) (breaking-change)
