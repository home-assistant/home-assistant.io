...
I'm going to put my hand up right away: ✋ I am _not_ a dashboard person. Not because I don't like them; I love seeing what you all build. But designing a beautiful one is a kind of visual creativity I just don't have. That's a big part of why I love the built-in [Home dashboard](/dashboards/home/) so much, it does the designing for me. But when I do build a custom dashboard, I usually stare at that "add a card" dialog for way too long, picking cards almost at random just to see if they look good with the data I have.
...
- **[Yoto]**, added by [@piitaya]  
  Control your [Yoto](https://yotoplay.com) audio players from Home Assistant. Play and pause cards, change the volume, skip and seek tracks, and see what is currently playing. The integration talks to the official Yoto cloud over <abbr title="Open Authorization 2.0">OAuth2</abbr> and receives playback updates over <abbr title="Message Queuing Telemetry Transport">MQTT</abbr>, so changes that happen on the player show up in Home Assistant almost immediately.
