...
<img class="no-shadow" src='/images/blog/2023-02/assist.png' alt='Screenshot showing one can adjust the precision of a sensor entity from the Home Assistant UI'>
...
- When selecting an entity from a list in the UI, it will now exclude already
  added entities. Helpful! Thanks, [@piitaya]!
...
- We have bumped the CHIP/Matter SDK version used by our [Matter] implementation
  to 1.0.0.2, which according to [their release notes], contains many fixes.
