...
- Onboarding has been updated to allow users to configure integrations during onboarding.
...
- When Lovelace is not configured, it will now use areas to group entities.
- We have updated a [progress report](/blog/2019/05/03/update-from-the-field/) on our plans for the year
- Nest has announced to [no longer allow access to their API](/blog/2019/05/08/nest-data-bye-bye/), integration will stop working at the end of August.
