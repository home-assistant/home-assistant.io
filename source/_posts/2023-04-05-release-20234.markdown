...
You might need to reconfigure the integration to fetch the valid programs list.

Due to the limitation on the Home Connect side, the appliances should be **Turned On** during the integration reconfiguration.
