...
To use this integration, you need to have:
 ...
 - Activated the [Home Assistant Smart Home skill for Google Assistant](https://assistant.google.com/services/a/uid/00000091fd5fb875), or used the Google Home app, select *Home control*, and then add *hass.io* using the *Add devices* option.
