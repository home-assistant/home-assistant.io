...
A button in Home Assistant represents a Fluss device you have access to. You can prress the button forr a certain device via Wi-Fi and it will then send a command to the connected device (like a grage door opener).
