...
Reboots the configured KLF 200 gateway. _This action will be deprecated in a future release. To reboot your gateway, use the **Reboot** button in Home Assistant's UI for the gateway device._
