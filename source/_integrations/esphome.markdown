...
To adjust the logging level, enable [debug logging](/docs/configuration/troubleshooting/#debug-logs-and-diagnostics), or use the Developer Tools to call the [`logger.set_level`](/integrations/logger/) action to specify the desired level:
