...
{% configuration_basic %}
Host:
  description: "The IP address or hostname of your BleBox device, for example `192.168.1.100` or `device.blebox`. You can find it in your router or in the wBox app."
Port:
