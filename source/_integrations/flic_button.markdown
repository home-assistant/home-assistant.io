...
1. Make the button is not connected to anything.
...
5. If you are having issues, try factory reset: Remove the battery and insert it aggain and immediately push and hold it for 7 seconds. When you release the button should blink with red a few times.
