...
radius:
  ...
  default: 20.0
categories:
  description: List of incident category names found in the feed. Only incidents from the feed that match any of these categories are included. Valid categories are 'Emergency Warning', 'Watch and Act', 'Advice', 'Planned Burn', 'Not Applicable'.
  required: false
  type: list
...
| category           | One of 'Emergency Warning', 'Watch and Act', 'Advice', 'Planned Burn', 'Not Applicable'.        |
