...
{% blueprint_example blueprint="casper_glow/bedtime_routine.yaml" %}
...
{% blueprint_example blueprint="casper_glow/pause_on_motion.yaml" %}
...
{% blueprint_example blueprint="casper_glow/turn_on_pause_nightlight.yaml" %}
