...
The **Ekey Bionyx** integration provides the following entities.
...
- Delete the integration in Home Assistant, set it up again (triggering the deletion process), and abort when you are in the step of naming the webhooks.
