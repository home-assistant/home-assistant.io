...
- You cannot link multiple HA instances to the same ekey Device

### Installation Instructions

In order to use the integration the ekey device needs to be set up in **plus mode** and the ekey Bionyx Api needs to be enabled in the App.
