...
The preferred way to configure an input text is via the user interface at {% my helpers title="Settings -> Devices & Services -> Helpers" %}. Click the add button and then choose the [**Text**](https://my.home-assistant.io/redirect/config_flow_start/?domain=input_text) option.
