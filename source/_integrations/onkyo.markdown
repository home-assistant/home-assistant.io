...
The above settings can also be adjusted later. To change `Host` or `Volume Resolution`, click the three-dot menu on the integration entry and select **Reconfigure**.
