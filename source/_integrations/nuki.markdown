...
The Nuki Smart Lock 3.0 Pro also [supports MQTT](https://support.nuki.io/hc/en-us/articles/12947926779409-MQTT-support) and can directly integrate with Home Assistant though [MQTT discovery](/integrations/mqtt/#mqtt-discovery).
For specific information can be found [here](https://developer.nuki.io/t/mqtt-api-specification-v1-3/17626).
