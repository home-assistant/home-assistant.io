...
The 2nd and 3rd Generation Smart Locks support HomeKit via Bluetooth and can directly integrate with Home Assistant.

## MQTT support

The Nuki Smart Lock 3.0 Pro and 4th generation devices also [supports MQTT]([https://support.nuki.io/hc/en-us/articles/12947926779409-MQTT-support]) and can directly integrate with Home Assistant through [MQTT discovery](/integrations/mqtt/#mqtt-discovery).
