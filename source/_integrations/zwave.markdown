...
This integration is deprecated. We recommend using <a href="/integrations/zwave_js">the Z-Wave JS integration</a>.
<br><br>
It will no longer receive any updates. It will not be removed unless it becomes incompatible with a future version of Python.
</p>
