...
documentation: https://www.home-assistant.io/integrations/rotarex
codeowners: []
iot_class: "cloud_polling"
---

The Rotarex DIMES SRG integration allows you to monitor the level, battery, and last sync time of your Rotarex DIMES SRG Camping gas tank app in Home Assistant.
...
1. In the pop-up, you will be asked to enter the **Email** and **Password** used in the Rotarex DIMES SRG Camping mobile app.
2. After submitting the credentials, the integration will be set up and a device will be created for each tank associated with your account.

## Sensors

This integration will create a device for each tank found in your account. Each device will have the following sensors:
