...
- **Status light brightness**: Controls the brightness of the green status light. Error statuses are always visualized, even if the slider is at 0.
...
- **Status light brightness**: Controls the brightness of the LED-strip. Error statuses are always visualized, even if the slider is at 0.
