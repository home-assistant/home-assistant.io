...
The Local calendar integration is a simple, fully local event store for automations. It is not a full personal calendar.
If you're looking for local or full-featured calendar alternatives, see the [Getting started with calendars section](/calendar#getting-started-with-calendars) for recommended options.
