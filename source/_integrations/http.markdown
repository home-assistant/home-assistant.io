...
If you want to use an HTTP sensor, create a [Long-Lived Access Token](https://developers.home-assistant.io/docs/auth_api/#long-lived-access-token) in the Home Assistant UI on your {% my profile_security title="**User profile** > **Security**" %} page.
