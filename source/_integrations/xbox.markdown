...
Home Assistant authenticates with Xbox Live through OAuth2 using the [Home Assistant Cloud account linking service](https://www.home-assistant.io/integrations/cloud/). Set up the integration through **Configuration -> Integrations -> Xbox**. Ensure you login using the Microsoft account that is linked to your Xbox consoles.
