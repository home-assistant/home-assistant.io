...
{% note %}
If the image does not meet the [minimum dimension requirements for previews](https://api.slack.com/methods/files.remote.add#markdown:~:text=dimension%20requirements%20for%20previews%20are%20a%20minimum%20of%20800w%20x%20400h.), it will be resized automatically.
{% endnote %}
