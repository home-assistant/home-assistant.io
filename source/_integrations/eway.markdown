...
- **Input Voltage**: Input voltage from solar 
panels (V)
- **Input Current**: Input current from solar 
panels (A)
- **Grid Frequency**: Grid frequency (Hz)
- **Temperature**: Device temperature (°C)
- **Energy Today**: Today's energy production 
(kWh)
- **Energy Total**: Total energy production 
(kWh)
- **Error Code**: Device error code (if any)
- **Working Duration**: Total working time 
(seconds)
...
1. Copy this integration folder to your Home 
Assistant `custom_components` directory
2. Restart Home Assistant
3. Add integration configuration to your 
configuration file

## Configuration

After installation, you need to configure the 
integration:
...
```yaml
# Example configuration.yaml (if using YAML 
configuration)
eway:
...
# Multiple devices
eway:
  - mqtt_host: "broker1.com"
    device_id: "device_1"
    device_sn: "serial_1"
    device_model: "model_1"
  - mqtt_host: "broker2.com"
    device_id: "device_2"
    device_sn: "serial_2"
    device_model: "model_2"
```
## MQTT Topics
