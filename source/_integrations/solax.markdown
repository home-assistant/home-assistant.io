...
If your inverter reports battery energy and power, you can also add the battery to the Energy dashboard. Configure the available battery charge and discharge energy sensors and, for the live power view, the battery power sensor.

Check the direction reported by the battery power sensor. If it reports a positive value while charging and a negative value while discharging, set **Type of power measurement** to **Inverted**. This makes the live Energy dashboard flows use the expected battery power direction.
