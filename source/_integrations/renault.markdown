...
- Buttons - to start air conditioning, start or stop the charge, set immediate charging, flash lights, and sound horn. Although available, these actions do not work on all vehicles.
