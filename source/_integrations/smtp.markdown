...
From name:
  description: Friendly name shown in emails.
To address:
  description: Default recipient(s). Comma-separate multiple addresses.
Connection timeout:
  description: How long to wait for server response (1-60 seconds).
Verify SSL certificate:
  description: Validate the server's SSL certificate.
