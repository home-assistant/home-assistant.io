...
**Warning**: you can create Input number helpers via the user interface, but it is impossible to change or delete them! If you want to be able to edit input number helpers, use yaml configuration instead. 
