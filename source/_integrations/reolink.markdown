...
- The siren turn off command does not work on the Reolink NVR, you need to power cycle the NVR/camera to stop the siren. Reolink is aware of this bug and is working on a solution.
