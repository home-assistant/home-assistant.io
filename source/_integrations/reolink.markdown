...
- It is advisable to set a static IP address for Reolink cameras/NVRs in your router, to prevent (temporal) connectivity issues when the IP address changes.
