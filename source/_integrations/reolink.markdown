...
Another exception are battery cameras, most enties are still polled every 60 seconds. However, the entities that would cause the camera to wake from sleep will only be polled during the following events:
