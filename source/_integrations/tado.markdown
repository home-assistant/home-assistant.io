...
automation:
    ...
    # Check if the room temp is more than 0.5 away from the tado thermostat reading
    condition. The sensors default to room temperature (20) when the reading is in error:
    - condition: template
      value_template: >
