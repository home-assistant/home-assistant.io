...
If your car is equipped with cooled (ventilated) seats, it will also create a select entity to control each cooled seat.
...
- Front left (if installed)
- Front right (if installed)
