...
With `advanced_mode` enabled, the user can choose to use their self hosted instance over the cloud servers. Self hosting comes with some requirements and limitations. More information can be found on the [Bumper's documentation](https://bumper.readthedocs.io)
