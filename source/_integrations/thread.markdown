...
related:
  ...
  - docs: /connect/zbt-2/
    title: Home Assistant Connect ZBT-2 - Zigbee/Thread USB stick
...
1. To enable Thread support on your Home Assistant Yellow, or Connect&nbsp;ZBT-1 or [Connect&nbsp;ZBT-2](/connect/zbt-2/), you need to install the **OpenThread Border Router** add-on. Follow the corresponding procedure:
