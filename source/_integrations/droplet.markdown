...
{% note %}
In order to report high and unusual flows, Droplet must be connected to Hydrific servers and be running v1.4.0 firmware or later.
{% endnote %}
...
**A**: It may take up to a minute for these sensors to update after initial setup. If they are still showing up as unknown, make sure your Droplet is connected to the server and running firmware v1.4.0 or later. High flow and unusual flow statuses require Hydrific server connectivity.
