...
climates:
  ...
  keys:
    ...
    scale:
      description: "**DEPRECATED** Scale factor (output = scale * value + offset) for setting target and current temperature."
      required: false
      type: float
      default: 1
    offset:
      description: "**DEPRECATED** Final offset for target and current temperature (output = scale * value + offset)."
      required: false
      type: float
      default: 0
    current_temp_scale:
      description: "Scale factor for current temperature (output = current_temp_scale * value + current_temp_offset). Ignoring deprecated 'scale'."
      required: false
      type: float
      default: 1.0
    current_temp_offset:
      description: "Offset for current temperature (output = current_temp_scale * value + current_temp_offset). Ignoring deprecated 'offset'."
      required: false
      type: float
      default: 0.0
    target_temp_scale:
      description: "Scale factor for target temperature (output = target_temp_scale * value + target_temp_offset). Ignoring deprecated 'scale'."
      required: false
      type: float
      default: 1.0
    target_temp_offset:
      description: "Offset for target temperature (output = target_temp_scale * value + target_temp_offset). Ignoring deprecated 'offset'."
      required: false
      type: float
      default: 0.0
