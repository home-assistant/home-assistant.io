...
The preferred way to configure an input select is via the user interface at [**Settings** -> **Devices & Services** -> **Helpers**](https://my.home-assistant.io/redirect/helpers/). Click the add button and then choose the [**Dropdown**](https://my.home-assistant.io/redirect/config_flow_start/?domain=input_select) option.
