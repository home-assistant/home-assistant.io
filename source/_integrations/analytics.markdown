...
Crash reports are only visible to the Home Assistant Core developers. This feature is currently limited to the [Supervisor](/docs/glossary/#home-assistant-supervisor) and [OS-Agent]([/docs/glossary/#os-agein-supervisor](https://github.com/home-assistant/os-agent)).
