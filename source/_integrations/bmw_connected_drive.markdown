...
<div class="note">
  ...
  If you do not want this, you should be able to trigger the `vehicle_finder` service from your phone and it should update in the within 5 minutes.
</div>

<div class="note">
  On some older cars (non i3/i8 series produced before 7/2014) this service will fail in getting your vehicles position, if the vehicle is more than 1.5 km away from the location of your HA instance. This is a limitation of the BMW API.
</div>
