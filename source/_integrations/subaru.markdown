...
Remote start and stop are available on supported Gen 2/3 vehicles. The remote start action uses the selected climate preset. If no option is selected, or the selection is invalid, it falls back to **Auto**.
