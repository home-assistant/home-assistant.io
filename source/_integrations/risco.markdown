...
If the integration fails to set up you can try to increase the optional `Communication delay` parameter to wait for the specified amount of seconds between opening the connection and starting the communication with the panel.
