...
recorder:
  ...
  keys:
    ...
    db_retry_wait:
      ...
      type: integer
    auto_purge:
      description: Automatically purge the database every night. This keeps it from growing indefinitely. If you disable this, you can still use the service [`recorder.purge`](#service-purge) when required.
      required: false
      default: true
      type: boolean
    purge_keep_days:
