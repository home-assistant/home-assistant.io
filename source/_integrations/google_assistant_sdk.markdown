...
[Google Developers Console](https://console.cloud.google.com/apis/api/embeddedassistant.googleapis.com).

1. First, go to the Google Developers Console to enable [Google Assistant API](https://console.cloud.google.com/apis/api/embeddedassistant.googleapis.com)
...
4. You can now see the details of what you are authorizing Home Assistant to access with two options at the bottom. Select **Continue**.
