...
For secure remote access, use a reverse proxy such as the {% my supervisor_addon addon="core_nginx_proxy" title="NGINX SSL" %} app instead of directing external traffic straight to Home Assistant.
{% endimportant %}
