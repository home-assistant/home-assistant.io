...
For secure remote access, use a reverse proxy such as the {% my supervisor_app app="core_nginx_proxy" title="NGINX SSL" %} app (formerly known as NGINX SSL add-on) instead of directing external traffic straight to Home Assistant.
{% endimportant %}
