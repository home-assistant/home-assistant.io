...
Verify that the Google Assistant is available on `https://[YOUR HOME ASSISTANT URL:PORT]/api/google_assistant` If its working it should return `405: Method Not Allowed` when opened in a browser or via curl
