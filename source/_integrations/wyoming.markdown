...
- Speech-to-Phrase {% my supervisor_app badge app="core_speech-to-phrase" %}
- Whisper {% my supervisor_app badge app="core_whisper" %}
- Piper {% my supervisor_app badge app="core_piper" %}
- openWakeWord {% my supervisor_app badge app="core_openwakeword" %}
