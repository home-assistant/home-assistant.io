...
### State-based template binary sensors, buttons, images, numbers, selects, sensors and switches
...
### Trigger-based template binary sensors, buttons, images, numbers, selects, sensors and switches
