...
{% configuration_basic %}
The precision of temperature sensors `DS18B20` can be configured for individual devices: the lower the precision, the faster the sensor will respond, but with less accuracy.
