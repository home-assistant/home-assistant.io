...
3. If issue is related to a specific Zigbee device, provide both "Zigbee Device Signature" and "Diagnostics" information. 
  * Both the "Zigbee Device Signature" and "Diagnostics" information can be found by clicking **Configuration** -> **Devices & Services** -> **Zigbee Home Automation** (click **Configure**) -> **Devices** (pick your device) -> Click "**Zigbee Device Signature**" and "**Download Diagnostics**" respectivly.
