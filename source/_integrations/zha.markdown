...
Newer Phillips Hue bulbs you can reset via Bluetooth. The offical Android app can connect to one of these bulbs even if it is already paired to a bridge. Then you can reset the bulb in the app.
