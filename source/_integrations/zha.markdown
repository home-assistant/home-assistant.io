...
If you are having problems pairing a device to then ZHA integratuon then it is recommended to verify that you try to follow recommended best practices to avoid pairing and/or connection issues:
