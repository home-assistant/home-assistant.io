...
- Silicon Labs EmberZNet based radios using the EZSP protocol (via the [bellows](https://github.com/zigpy/bellows) library for zigpy)
  ...
  - Tuya TYGWZ-01 and Lidl Silvercrest Smart Home Gateway (Note! This first have to be [rooted and a serial gateway installed](https://paulbanks.org/projects/lidl-zigbee/ha.html))
