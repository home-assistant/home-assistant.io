...
This action allows you to play one of the built-in Alexa sounds. The full list of sounds is available in [Amazon's documentation](https://alexa.amazon.it/api/behaviors/entities?skillId=amzn1.ask.1p.sound)
