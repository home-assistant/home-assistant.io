...
- **Operation state**:
  ...
  - **Start**: Shows the date and time of program start. If the appliance has been set with delayed start, it reports the time when the appliance will effectively start the cycle.
  - **Finish**: Shows the date and time of estimated program end. If the appliance has been set with delayed start, it reports the time when the appliance is expected to end the cycle, also considering delayed start time.
