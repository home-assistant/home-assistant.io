...
- **Operation state**:
  ...
  - **Core temperature**: Shows the core temperature of the food in ovens with appropriate temperature probe.
  - **Target core temperature**: Shows the set core target temperature for the food  in ovens with appropriate temperature probe.
