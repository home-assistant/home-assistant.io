...
What states a device tracker can have depends on the data source it is using: GPS or router.
...
A device tracker with **router** as source will only have one of two states: **Home**, or **Not home**.
