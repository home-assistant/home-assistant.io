...
There is no need to manually install this integration. The Assist pipeline integration is part of the default configuration and setup automatically if needed by other integrations.