...
Add New Script > Add Action > Philips Hue: Activate Scene

Then select the appropriate room name in the Group field and the scene name in the Scene field stored on your Hue bridge.
