...
- Scene entities are not automatically created for V1 bridges. To activate a Hue scene on a V1 bridge from Home Assistant, there's an action that allows you to activate the Hue scene by name.
