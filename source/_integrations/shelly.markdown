...
- Shelly AZ H&T is not supported because the device does not support Outbound WebSocket, which is required for real-time communication with the integration.
