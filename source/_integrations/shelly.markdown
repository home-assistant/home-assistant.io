...
- Shelly AZ H&T is not supported because the device does not support WebSocket Outbound, which is required for real-time communication with the integration.
