...
Shelly BLU series devices (e.g. Shelly BLU H&T) are not supported by this integration, please use BTHome integration to configure them with Home Assistant. The exception to this is Shelly BLU TRV which is supported by this integration via Shelly BLU Gateway Gen3.
