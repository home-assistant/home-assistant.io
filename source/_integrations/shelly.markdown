...
- If `Channel Name` is set in the device, the integration will use it to generate the sub-device name.
- If `Channel Name` is set in the device, the integration will use it to generate the entities' name.
- If channel names are set, they will be used in the entity names and sub-device names. The device name will be used only for main device name.
