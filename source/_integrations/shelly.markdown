...
Shelly's devices rely on [SNTP](https://en.wikipedia.org/wiki/Network_Time_Protocol) for some of their features, like power measurement.
Please ensure that the configured server is reacheable.
