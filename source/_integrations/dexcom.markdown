...
You will need to set up the [Dexcom Share](https://provider.dexcom.com/education-research/cgm-education-use/videos/setting-dexcom-share-and-follow) feature in your Dexcom G6 App to use this integration. The service requires setup of at least one follower to enable the share service, but the intergration will use the Dexcom user's credentials, not the follower's credentials.
