...
If the lights show as unavailable the issue usually is that webhook is banned by Netatmo. To solve that go to the [Netatmo Developer Page](https://dev.netatmo.com/) to unban your webhook and then restart the integration.
