...
2. Follow the instructions to generate the QR code to scan within the Starling mobile app to authorise and link your bank account to the developer account. 
