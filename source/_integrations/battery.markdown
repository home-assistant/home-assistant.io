...
For an overview of the status of your battery {% term entities %}, open {% my maintenance title="**Maintenance** dashboard" %}. This [dashboard](https://www.home-assistant.io/dashboards/dashboards/#dashboards-only-shown-in-the-dashboard-list-by-default) allows you to quickly see which batteries need replacing.
