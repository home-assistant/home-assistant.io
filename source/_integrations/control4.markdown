...
The username and password required for this integration are the same credentials you use to log in to the Control4 customer portal at [https://customer.control4.com/](https://customer.control4.com/).
