...
related:
  ...
  - url: https://platform.xAI.com/account/api-keys
    title: xAI API key
...
This integration requires an API key to use, [which you can generate here.](https://platform.xAI.com/account/api-keys). This is a paid service, we advise you to monitor your costs in the [xAI portal](https://platform.xAI.com/account) closely and configure [usage limits](https://platform.xAI.com/account/billing/limits) to avoid unwanted costs associated with using the service.
...
Maximum Tokens to Return in Response:
  description: The maximum number of words or "tokens" that the AI model should generate in its completion of the prompt. For more information, see the [xAI Completion Documentation](https://platform.xAI.com/docs/guides/completion/introduction).
Temperature:
...
You can use an xAI Conversation integration to [talk to Super Mario and, if desired, have it control devices](/voice_control/assist_create_open_ai_personality/) in your home.

## Actions

### Action `xai_conversation.generate_image`

Allows you to ask xAI to generate an image based on a prompt. This action
...
![Open AI Conversation UI Mode](/images/integrations/xAI_conversation/xAI_developer_tools_ui.png)

Select **YAML Mode** to reveal the *config_entry* value to be used in the below example automation.

![Open AI Conversation YAML Mode](/images/integrations/xAI_conversation/xAI_developer_tools_yaml.png)
...
automation:
  - alias: "Update image when weather changes"
    ...
    actions:
      - alias: "Ask xAI to generate an image"
        action: xAI_conversation.generate_image
        response_variable: generated_image
        data:
          config_entry: abce6b8696a15e107b4bd843de722249
