...
Max history messages:
  description: Maximum number of messages to keep for each conversation (0 = no limit; -1 = no retention). Limiting this value will cause older messages in a conversation to be dropped.
Keep alive:
