...
sensor:
  ...
  sensor_id: 0x0000 + Mac address (w/ `:`'s removed)
```
...
api_secret:
  ...
  type: string
sensor_id:
  description: As of 2020-07-26, the sensor ID must be provided (it can be found on this page [MyPWRView page]( https://mypwrview.generac.com/#settings/sensors) or derived from the device's MAC address)
  required: true
  type: string
{% endconfiguration %}
