...
To use the integration, you need to get the API key by signing up at [Kaiterra dashboard](https://dashboard.kaiterra.com/), registering the device and create the key under `Settings -> Profile -> Developer`.
