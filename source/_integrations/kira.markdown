...
Restart Home Assistant and you should now have an entity called `kira_remote` (or whatever you called it). To check, go to **Settings** > **Tools** > **States** and start to type “kira” within the entity list.
