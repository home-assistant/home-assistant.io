...
The `russound_rio` {% term integration %} allows you to control Russound devices that make use of the RIO protocol. All devices that are compatible with the [Russound app](https://www.russound.com/russound-app) are compatible.
