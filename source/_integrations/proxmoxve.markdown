...
{% important %}
To keep things secure, create a dedicated Proxmox VE user for Home Assistant and only grant the permissions you need. In short, we recommend not using the default `root` account.
{% endimportant %}
