...
- Audio unmute offset (Controls time offset before sending audio data to SINK0)
- eARC unmute offset (Controls time offset before sending audio data to eARC TX)
