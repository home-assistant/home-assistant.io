...
Attributes (not available when using the legacy protocol):
- Temperature
- Total consumption - total power consumption in kWh
- Current consumption - current power consumption in W
