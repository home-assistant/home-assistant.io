...
<div class="note">
    Note: you must use a valid/trusted SSL Certificate for account linking to work. Self signed certificates will not work, but you can use a free Lets Encrypt Certificate.
</div>
