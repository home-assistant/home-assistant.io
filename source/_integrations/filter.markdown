...
The Median filter takes the preceding `window_size` previous states up to the current value, adds the current state and then computes the median value of this set.
