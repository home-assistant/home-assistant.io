...
Moisture and humidity  integrations both work with water, but they apply to different aspects:
...
- **Humidity** describes water vapor in the air. It's reported as a relative humidity percentage by climate devices, humidifiers, weather sensors, and dedicated humidity sensors. For automations based on humidity, use the [humidity triggers](/integrations/humidity/) and [humidity conditions](/integrations/humidity/) instead.
