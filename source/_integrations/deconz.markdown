...
An official Home Assistant app for deCONZ is available in the Home Assistant app store.
...
- If you are running the Home Assistant app, you can see the hostname on the app page under [**Settings** > **App** > **deCONZ**](https://my.home-assistant.io/redirect/supervisor_addon/?addon=core_deconz), under **Hostname**.
