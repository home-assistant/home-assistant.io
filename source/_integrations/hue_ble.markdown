...
This integration requires an active Bluetooth connection to control lights which not all bluetooth adapters are able to provide. See the [Bluetooth documentation](https://www.home-assistant.io/integrations/bluetooth/) for more information about which adapders can provide an active connection.
