...
Brottsplatskartan captures all incidents in a region, for example Stockholms län. If area parameter is defined, any latitude and longitude parameters are ignored.
