...
The **devolo Home Network** {% term integration %} integration allows you to monitor and control your [devolo](https://www.devolo.global) PLC network. Depending on the device you add to Home Assistant, different use cases are possible. Roughly you can divide the devices into Wi-Fi and non-Wi-Fi devices. The non-Wi-Fi devices are more or less limited to monitor your PLC network. The Wi-Fi devices, however, can help with presence detection and controlling your guest Wi-Fi remotely. For details, please continue reading about the [entities](#entities) and look at the [supported devices](#supported-devolo-devices).
