...
- For v4 and v5 devices, you can provide your Xiaomi Cloud account login credentials for the account to which the device is bound, and Home Assistant will import the appropriate bind key from your account.
