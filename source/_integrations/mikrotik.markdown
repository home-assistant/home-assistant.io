...
To use this device tracker you only need limted privileges. To enhance the security of your MikroTik device create a "read only" user who is able to connect to API and perform ping test only:
