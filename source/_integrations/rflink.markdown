...
{% important %}
This _legacy_ format will stop working on Home Assistant 2026.10.0.
{% endimportant %}
...
Legacy RFLink configuration format is deprecated and will be removed in Home Assistant 2026.10.0. The deprecated configuration will produce a repair that directs you to this section.
