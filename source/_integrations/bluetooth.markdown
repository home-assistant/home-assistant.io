...
The **Bluetooth** {% term integration %} supports Bluetooth Low Energy devices. It detects nearby supported devices, which will show up in the discovered section on the integrations page in the configuration panel.
