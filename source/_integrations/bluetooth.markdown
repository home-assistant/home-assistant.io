...
These adapters may require additional patch files available at [https://github.com/winterheart/broadcom-bt-firmware](https://github.com/winterheart/broadcom-bt-firmware) for stable operation.
