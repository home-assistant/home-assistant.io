...
The limit is 3 calls to start/stop/suspend a zone per 30 seconds and an an additional limit across the entire API of 30 calls in a 5 minute period per user.
</div>
