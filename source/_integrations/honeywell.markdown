...
- Sensors
  - Indoor and Outdoor Temperature sensor entities
  - Indoor and Outdoor Humidity sensor entities
...
The sensor platform integrates inside and outside temperature and humidity into Home Assistant as sensors for each device.
...
|Indoor temperature | Temperature as measured at the thermostat|
|Indoor humidity | Humidity as measured at the thermostat|
