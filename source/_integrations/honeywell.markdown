...
There is a "known" issue related to setting temperature from Home Assistant with some thermostats.  If your instance recieves errors when setting the temperature above or below some value, go the the Honeywell web page and set the tempurature to the max or min for the mode you are using, then adjust from Home Assistant.
