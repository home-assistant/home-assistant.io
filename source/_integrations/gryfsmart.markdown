...
You can list all devices using the following commands:
...
- **Icon:** switch, outlet
- **Entity type:** switch
- **Configuration scheme:** with device class
...
- Names may include uppercase letters, numbers, and spaces, but no
