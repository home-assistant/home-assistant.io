...
- **Limited**: Indicates whether the account has been [limited](https://docs.joinmastodon.org/admin/moderation/#limit-user) by moderatos. Limited accounts are hidden from users on the instance, and their content is not publicly visible.
