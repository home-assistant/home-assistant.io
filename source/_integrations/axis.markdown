...
The **Doorbell** event is supported for the AXIS I8116-E Intercom. This event is triggered when the doorbell button is pressed, allowing you to create automations or notifications in response to doorbell activity.
