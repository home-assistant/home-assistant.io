...
<div class='note info'>
Once integration is set up, only `climate` entity is enabled. To avoid clutter in the state history, all sensors are disabled by default. If you're willing to use them, please navigate to the entities list and enable them.
</div>
