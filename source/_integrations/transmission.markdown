...
Adds a new torrent to download. It can either be a URL (http, https or ftp), magnet link or a local file (make sure that the path is [white listed](https://www.home-assistant.io/docs/configuration/basic/#whitelist_external_dirs)).
