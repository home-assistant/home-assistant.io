...
The list of commands that can be sent to the TV depends on the model of your TV. To display the available list of commands for your TV, call the service `remote.send_command`. The list of available commands will be displayed in “Notifications” (the bell icon) in the lower-left of the Home Assistant UI.
