...
This section shows you how to set up a Z-Wave JS server and how to add your first Z-Wave device to Home Assistant. If you are new to Z-Wave, check out the [terminology section](#z-wave-terminology).
