...
7. Once the migration is complete, check if you want to rename the adapter. If you have previously changed the name, the new adapter might keep the name of the old adapter.
