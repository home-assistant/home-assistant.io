...
| switch                                                        | Switch                 | Represented as a switch by default but can be changed by using `type` within  `entity_config`. Valve switches (type `faucet`, `shower`, `sprinkler`, or `valve`) can be linked with `linked_valve_duration` and/or `linked_valve_end_time`.                                                                                                                                                                                                                                                                                                                                                |
...
| valve                                                         | Valve                 | All `valve` devices. Can be linked with `linked_valve_duration` and/or `linked_valve_end_time`.                                                                                                                                                                                                                                                                                                                                                                                                                         |
