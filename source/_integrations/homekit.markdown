...
:::tip
Categorized entities are not included (config, diagnostic, and system entities) unless they are explictly matched by `include_entity_globs` or `include_entities` or selected in the UI in include mode.
:::
