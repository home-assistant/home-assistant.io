...
The link provided needs to be tweaked: replace 'localhost:8000/point?' with 'https://hassurl:8123/api/minut?'; leave the rest of the link untouched. It seems to work best in MS Edge.
