...
On the same page you can see your plan: free of charge, if the associated Google Cloud project doesn't have billing, or pay-as-you, if the associated Google Cloud project has billing enabled.
