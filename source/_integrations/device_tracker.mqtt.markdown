...
availability_topic:
  ...
  type: string
device:
  description: "Information about the device this device trigger is a part of that ties it into the [device registry](https://developers.home-assistant.io/docs/en/device_registry_index.html)."
  required: false
  type: map
  keys:
    connections:
