...
| `media_content_type`   |       no | A media type. Must be one of `url`, `video`, `album`, `music`, `playlist`, `channel`, `podcast`, `season`, `episode` ,`track`, `image`, `app`, `apps`, `artist`, `channels`, `composer`, `contributing_artist`, `game`, `genre`, `movie`, `tvshow`. For example, to play music you would set `media_content_type` to `music`. |
