...
The `vacuum.clean_area` action tells the vacuum to clean one or more specific areas. The areas you select are mapped to the vacuum's internal segments. This action is only available for vacuums that support area-based cleaning.

| Data attribute | Optional | Description                                                      |
| ---------------------- | -------- | ---------------------------------------------------------------- |
| `entity_id`            | yes      | Only act on specific vacuum. Use `entity_id: all` to target all. |
| `cleaning_area_id`     | no       | One or more areas for the vacuum to clean.                       |
