...
3. Select **Map vacuum to areas**.
   ...
   - If you do not see the **Map vacuum to areas** option, your vacuum does not support area cleaning. You can not use the `vacuum.clean_area` action with this vacuum.
