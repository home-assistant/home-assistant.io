...
- **Battery voltage**: The current battery voltage of the device, in volts. This entity is disabled by default.
- **Signal strength**: The Wi-Fi signal strength of the device, in dBm. This entity is disabled by default.
- **Wi-Fi strength**: The Wi-Fi signal quality of the device, in percent. This entity is disabled by default.
...
triggers:
  - trigger: numeric_state
    entity_id: sensor.trmnl_battery
    below: 20
actions:
