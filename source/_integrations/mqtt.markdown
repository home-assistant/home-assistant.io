...
{% details "Platform components supported by MQTT discovery" %}
...
- `<component>`: One of the supported MQTT platform components, eg. `binary_sensor`.
...
{% details "MQTT platform components that support setup via YAML" %}
...
The MQTT notification support is different than for the other [notification](/integrations/notify/) platform components. It is a service. This means you need to provide more details when calling the service.
