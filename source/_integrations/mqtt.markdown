...
| `message_expiry_interval` | yes   | Set the [Message Expriry Interval](https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc3901048) for the message published. This option is only supported with MQTT protocol version 5. |
