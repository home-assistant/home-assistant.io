...
## Adding devices
Many devices can be automatically added via [MQTT Discovery](/docs/mqtt/discovery/). 
But If you need to add devices manually, you can go ahead and and add it to your `configuartion.yaml` file.
The following integerations are supported:
