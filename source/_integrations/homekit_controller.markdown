...
2. On the HomeKit Device integration, select **Add**.
...
2. On the HomeKit Bridge integration, select **Add**.
...
2. Under **{% my integrations title="Settings > Devices & services" %}**, on the HomeKit integration, select **Add**.
