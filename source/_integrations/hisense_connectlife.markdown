...
description: Instructions on how to integrate Hisense air conditioners, water heaters, and dehumidifiers into Home Assistant through the ConnectLife cloud platform.
ha_category:
  - Climate
  - Water Heater
  - Sensor
...
The Hisense ConnectLife integration allows you to control and monitor Hisense air conditioners, water heaters, dehumidifiers, and other connected devices through the ConnectLife cloud platform.
...
2. Search for "Hisense ConnectLife"
3. Click **Configure**
