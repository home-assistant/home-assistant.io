...
A {% term calendar %} entity will be created indicating the day of release and type of release, such as Cinemas, Digital, or Physical. The calendar uses the configured **Upcoming days** value when looking ahead for the next release.
