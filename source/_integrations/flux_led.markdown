...
### Depreceated configuration.yaml

*** **It is highly recommended to use the UI to configure `Flux_LED`. The option to use `configuration.yaml` will be removed in furture releases.** ***

The `Flux_LED` integration can be configured in the UI or in the 
