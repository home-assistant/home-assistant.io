...
When a Doorbell rings there is a specific event {% term entity %} that provides the `event_id`, you can use this to get the thumbnail e.g. `event.g4_doorbell_pro_doorbell`.
