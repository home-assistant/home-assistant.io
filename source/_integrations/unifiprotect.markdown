...
{% note %}
The event data Home Assistant receives does not identify which configured line was crossed or the crossing direction. Home Assistant can therefore report that a line crossing occurred, but it cannot provide a line name, line ID, or direction.
{% endnote %}
