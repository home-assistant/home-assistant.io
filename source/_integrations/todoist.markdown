...
You need to determine your Todoist API token. This is fairly simple to do; just go [to the Integrations > Developer section on your Todoist settings page](https://todoist.com/app/settings/integrations/developer) and find the section labeled "API token" at the bottom of the page. Copy that token and use it in your configuration file.
