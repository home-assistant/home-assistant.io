...
### Backups appear under the wrong Home Assistant instance
...
Problematic prefix structure:

- Instance A: `homeassistant/prod/`  
- Instance B: `homeassistant/test/`  
- Instance C: `homeassistant/`
