...
- **Peristaltic ORP dosing**
  ...
  - **Values**: Off, Proportional, On/Off, Timed
- **Chlorine type dosing**
  - **Description**: Type of chlorine dosing being used.
  - **Values**: Low, High
- **Peristaltic chlorine dosing**
  - **Description**: Chlorine peristaltic dosing mode.
  - **Values**: Off, Proportional, On/Off, Timed
- **Overfeed alert ORP time**
  - **Unit**: min
