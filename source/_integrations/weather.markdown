...
The **Weather** {% term integrations %} gather meteorological information from web services and display the conditions and other details about the weather at the given location.
