...
1. Logging in at [Cisco Webex for Developers](https://developer.webex.com/) and navigate to `Documentation`>`Webex Messaginig`>`All APIs`>`Messages` and select List Messages.
