...
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> max reported**: Maximum power production measured by the inverter. This entity is disabled by default for all inverters.
...
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> dc voltage**: DC voltage measured by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> dc current**: DC current measured by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> ac voltage**: AC voltage measured by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> ac current**: AC current measured by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> frequency**: frequency measured by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> temperature**: temperature measured by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> energy produced**: energy produced by the inverter during last report cycle.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> energy today**: energy produced today by the inverter.
- **Inverter <abbr title="micro-inverter serial number">SN</abbr> lifetime energy**: total energy produced during inverter lifetime.
