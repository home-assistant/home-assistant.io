...
- The triggers and conditions are also based only on the phase and the waxing or waning direction. They do not react to moonrise, moonset, the moon's elevation, or the exact percentage of illumination.
