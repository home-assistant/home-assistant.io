...
Firefly III is a free open-source personal finance manager. It contains a full transaction management system, budgets, categories and reports. You can easily import transactions via the divers options Firefly III offers. It even contains a rule engine to automate and help organize your bookkeeping.
