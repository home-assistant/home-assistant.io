...
If this is the case, your sensors will use a UUID to distinguish the data streams within that single account.
The UUID will not tie back to any identifier used by the utility.
...
2. Select **Opower {utility name} elec {account number/UUID} consumption** for the **consumed energy**.
3. Select the radio button to **Use an entity tracking the total costs**.
4. Select **Opower {utility name} elec {account number/UUID} cost** for the **entity with the total costs**.
...
2. Select **Opower {utility name} gas {account number/UUID} consumption** for the **gas usage**.
3. Select the radio button to **Use an entity tracking the total costs**.
4. Select **Opower {utility name} gas {account number/UUID} cost** for the **entity with the total costs**.
