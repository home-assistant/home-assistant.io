...
- Redirect URI  : `<YOUR_LOCAL_HOME_ASSISTANT_URL>/auth/external/callback` # Use your local IP address or hostname. Example `http://homeassistant.local:8123/auth/external/callback`
