...
- Redirect URI  : `<YOUR_INTERNAL_HOME_ASSISTANT_URL>/auth/external/callback` # Use same the address defined as `internal_url` in your configuration settings. Example `http://192.168.1.24:8123/auth/external/callback`
