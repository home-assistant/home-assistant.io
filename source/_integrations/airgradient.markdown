...
A number of configuration entities are available as sensors to automate with if you set up the device via AirGradient Cloud instead of setting it up locally.
