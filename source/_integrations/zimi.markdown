...
| Garage Door Controller          | Cover          | 1xCover<br>2xSensor | Cover {Name}<br>Cover {Temperature}<br>Cover {Humidity}          | Yes       |
...
- Cover entity: Basic open and close as set to percentage
