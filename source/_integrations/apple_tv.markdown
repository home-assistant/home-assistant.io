...
lounge_appletv_netflix:
  ...
  - service: media_player.select_source
    ...
    data:
      source: Netflix
```
**Note**: Source is case sensitive. You can check the options and proper names selecting the media.player entity created for your AppleTV once it is on, or at the **Developer Tools > States**
