...
3. [`base_url` of the http component](/integrations/http#base_url) set the URL that Home Assistant is available on the internet.  SmartThings requries this base_url to use a standard port (443).
