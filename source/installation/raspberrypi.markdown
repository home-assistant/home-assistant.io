...
- [Micro SD Card](https://amzn.to/2X0Z2di).
  - Ideally get one that is [Application Class 2](https://www.sdcard.org/developers/overview/application/index.html). Check for the label **A2** on the card. Application Class 2 cards perform better on both read and write operations and are better suited to host applications.
