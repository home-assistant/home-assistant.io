...
3. Still on the Account Linking Page, after saving, click the `Test` Button at the upper right corner. You do not need to actually test anything, the test just needs to be generated. Be sure **NOT** to press the button in the upper navigation bar, the test is not generated by this button.
