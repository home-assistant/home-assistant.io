...
| `method` | no | Array of positional parameters to pass to Logitech Media Server.
...
- Action: JSON post query with such JSON body: `{ "entity_id": "media_player.squeezebox_radio", "method": ["playlist", "loadtracks", "album.titlesearch={{TextField}}"] }`
