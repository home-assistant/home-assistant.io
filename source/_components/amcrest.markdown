...
- **name** (*Optional*): This parameter allows you to override the name of your camera. The default is "Amcrest Camera". Setting a name will also give you an easy entity ID (ex: `name: Den` entity_id: camera.den).
