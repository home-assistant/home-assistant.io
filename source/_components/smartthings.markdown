...
| Capability        |Component/Platform
|-------------------|------------------------------------------------------------|
| [switch](https://smartthings.developer.samsung.com/develop/api-ref/capabilities.html#Switch)            | [switch.smartthings](/components/switch.smartthings)
