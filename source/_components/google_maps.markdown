...
2. You need to use an addon that can export valid cookies from your authenticated account once you have successfully authenticated. Addons tested and working are [Export Cookies](https://addons.mozilla.org/en-US/firefox/addon/export-cookies-txt/?src=search) for firefox (make sure "Prefix HttpOnly cookies" is NOT checked for the cookies to work) and [cookies.txt](https://chrome.google.com/webstore/detail/cookiestxt/njabckikapfpffapmjgojcnbfjonfjfg?hl=en-US) for chrome.
