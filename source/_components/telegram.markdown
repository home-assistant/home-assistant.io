...
- You need to configure a [Telegram bot in Home Assistant](/components/telegram_chatbot/) and define there your API key and the allowed chat ids to interact with.
