...
The Z-Wave component exposes five services to help maintain the network.
...
| test_network | (in 0.17) Tells the controller send out a no-op command to each node and measure the time for a response. In theory, this can also bring back nodes which have been marked "presumed dead".|
