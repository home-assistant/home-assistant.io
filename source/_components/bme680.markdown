...
aq_humidity_bias:
  ...
  type: integer
temp_offset:
  description: "The temperature for the sensor will always be too high as it pulls heat from the integrations around it.  Consider adding a negative offset to ensure the sensor returns an accurate temperature. Note: This value is in celsius."
  required: false
  default: 0
  type: float
{% endconfiguration %}
