...
<p class='note'>
Both Google Home and Alexa devices communicate through the device they were initially set up with, so if that device is removed from the network, emulated_hue will cease to fnction unless it is re-added. (see [here]https://community.home-assistant.io/t/41839))
</p>
