...
<p class='note'>
If you use MariaDB 10 you need to add port 3306 (or another port depending on which port is used by, for example: your hosting provider.) to the SERVER_IP, e.g., `mysql://user:password@SERVER_IP:3306/DB_NAME?charset=utf8`.
</p>
